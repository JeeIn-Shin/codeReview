        ...
        y = (function () {
            ...
            return (
                ...
                (n._slide = function (t, n) {
                    ...
                    if (
                        ("next" === t ? ((i = "carousel-item-left"), (o = "carousel-item-next"), (r = "left")) : ((i = "carousel-item-right"), (o = "carousel-item-prev"), (r = "right")),
                        ...
                        if ((e(r).trigger(o), !o.isDefaultPrevented())) {
                            if (!this._inNavbar && n) {
                                ...
                                "parent" === this._config.reference
                                    ? (s = r)
                                    : l.isElement(this._config.reference) && ((s = this._config.reference), "undefined" != typeof this._config.reference.jquery && (s = this._config.reference[0])),
                    ...
                    if (!n || (3 !== n.which && ("keyup" !== n.type || 9 === n.which)))
                        for (var i = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), o = 0, r = i.length; o < r; o++) {
                            ...
                            if ((n && "click" === n.type && (l.clickEvent = n), a)) {
                                ...
                                if (
                                    e(s).hasClass("show") &&
                                    !(n && (("click" === n.type && /input|textarea/i.test(n.target.tagName)) || ("keyup" === n.type && 9 === n.which)) && e.contains(s, n.target))
                                ) {
