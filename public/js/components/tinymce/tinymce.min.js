...
!(function () {
  ...
  const I = Array.prototype.slice,
    ...
    Ee = (e, t, n) => {
      ...
      if (((n = n || e), void 0 !== e.length)) {
        ...
        for (o in e) if (xe(e, o) && !1 === t.call(n, e[o], o, e)) return !1;
      return !0;
    },
    Ne = (e, t) => {
      const n = [];
  ...
  const Ct = () => yt(),
    ...
    Ot = (e, t) =>
      t ? !("array" !== t || !_e(e)) || typeof e === t : void 0 !== e,
    Tt = function (e, t, n, o) {
      (o = o || this),
        e &&
          (n && (e = e[n]),
    ...
    Bt = {
      ...
      resolve: (e, t) => {
        let n, o;
        for (
          t = t || window, n = 0, o = (e = e.split(".")).length;
          n < o && (t = t[e[n]]);
          n++
        );
        return t;
  ...
  const Mt = (e) => e.dom.nodeName.toLowerCase(),
    ...
    ao = (e, t, n, o) =>
      ((e, t, n, o, r) => {
        ...
        return (
          e.dom.addEventListener(t, s, false), { unbind: O(io, e, t, s, false) }
        );
      })(e, t, n, o),
    io = (e, t, n, o) => {
        ...
        loadAll: (e) =>
          Promise.allSettled(H(e, (e) => i(e).then(N(e)))).then((e) => {
            ...
            return t.fail.length > 0
              ? Promise.reject(H(t.fail, (e) => e.reason))
              : H(t.pass, (e) => e.value);
          }),
        unload: l,
        unloadAll: (e) => {
  ...
  class Qo {
    ...
    findPreviousNode(e, t) {
      let n, o, r;
      if (e) {
        if (((n = e.previousSibling), this.rootNode && n === this.rootNode))
          return;
        if (n) {
          if (!t)
  ...
  const Jo = ["pre"].concat(["h1", "h2", "h3", "h4", "h5", "h6"]),
    ...
    yr = Ro,
    Cr = (e) => (
      yr(e) && (e = e.parentNode), vr(e) && e.hasAttribute("data-mce-caret")
    ),
    wr = (e) => yr(e) && hr(e.data),
    xr = (e) => Cr(e) || wr(e),
    ...
    Sr = (e) => {
      ...
      return (
        ...
        (t.data.charAt(e.offset()) === pr ||
          (e.isAtStart() && wr(t.previousSibling)))
      );
    },
    _r = (e) => {
      const t = e.container();
    ...
    Ir = xr,
    Fr = (e) =>
      !Ir(e) && (Dr(e) ? !Pr(e.parentNode) : Lr(e) || Br(e) || Mr(e) || Ur(e)),
    Ur = (e) =>
      !1 === ((e) => Co(e) && "true" === e.getAttribute("unselectable"))(e) &&
      Tr(e),
    zr = (e, t) =>
      Fr(e) &&
      ((e, t) => {
          ...
          (e, t) =>
            ((e) => -1 !== " \f\t\v".indexOf(e))(t) || t === fr
              ? e.pcIsSpace ||
                ...
                ((e, t) => t < e.length && t >= 0 && Hr(e[t]))(
                  s,
                  e.str.length + 1
                )
                ? { pcIsSpace: !1, str: e.str + fr }
                : { pcIsSpace: !0, str: e.str + " " }
              : { pcIsSpace: Hr(t), str: e.str + t },
          { pcIsSpace: !1, str: "" }
        );
      return a.str;
    },
  ...
  const Yr = (e, t = !0) =>
    ...
    us = (e, t, n) => (
      (n = n || ls), e.replace(t ? es : ts, (e) => ss[e] || n[e] || e)
    ),
    ms = {
      encodeRaw: ds,
    ...
    Ss = (e) => {
      ...
      const s = {},
        ...
        i = (t, n, o) => {
          ...
          return (
            r
              ? (r = ps(r, /[, ]/, ps(r.toUpperCase(), /[, ]/)))
              : ((r = fs[t]), r || ((r = ws(n, o)), (fs[t] = r))),
            r
          );
        },
      ...
      const k = (e) => new RegExp("^" + e.replace(/([?+*])/g, ".$1") + "$"),
        S = (e) => {
          ...
          if (e) {
            const _ = Cs(e, ",");
            for (
              n["@"] && ((v = n["@"].attributes), (y = n["@"].attributesOrder)),
                t = 0,
                o = _.length;
              t < o;
              t++
                    ...
                    if (((i = x.exec(c[s])), i)) {
                      ...
                      h &&
                        ("=" === h &&
                          ...
                          l.attributesDefault.push({ name: m, value: C }),
                          (d.defaultValue = C)),
                        "~" === h &&
                          ((l.attributesForced = l.attributesForced || []),
                          l.attributesForced.push({ name: m, value: C }),
                          (d.forcedValue = C)),
                        "<" === h && (d.validValues = ps(C, "?"))),
                        S.test(m)
                          ? ((l.attributePatterns = l.attributePatterns || []),
                            (d.pattern = k(m)),
                            l.attributePatterns.push(d))
                          : (g[m] || p.push(m), (g[m] = d));
                    }
                v || "@" !== u || ((v = g), (y = p)),
                  b && ((l.outputName = u), (n[b] = l)),
                  S.test(u) ? ((l.pattern = k(u)), r.push(l)) : (n[u] = l);
              }
          }
        },
        _ = (e) => {
        ...
        E = (e) => {
          const t = /^(~)?(.+)$/;
          e &&
            ((fs.text_block_elements = fs.block_elements = null),
            hs(Cs(e, ","), (e) => {
              const r = t.exec(e),
                a = "~" === r[1],
                i = a ? "span" : "div",
      ...
      e.valid_elements
        ...
        : (hs(d, (e, t) => {
          ...
          hs(
            Cs("p h1 h2 h3 h4 h5 h6 th td pre div address caption li"),
            (e) => {
              n[e].paddEmpty = !0;
            }
          ),
          ...
          if (t) {
            for (
              ...
              if (
                ...
                if (
                  !e.allow_script_urls &&
                  ("behavior" === d || /expression\s*\(|\/\*|\*\//.test(u))
                )
                  continue;
                "font-weight" === d && "700" === u
                  ? (u = "bold")
                  : ("color" !== d && "background-color" !== d) ||
                    (u = u.toLowerCase()),
                  (u = u.replace(n, w)),
                  (i[d] = m ? v(u, !0) : u);
              }
    ...
    Ds = (e, t, n) => {
      ...
      "complete" === o.readyState || ("interactive" === o.readyState && o.body)
        ? s()
        : Os(e, "DOMContentLoaded", s),
        n.domLoaded || Os(e, "load", s);
    };
  class Ps {
    constructor() {
      (this.domLoaded = !1),
    ...
    bind(e, t, n, o) {
      ...
      e[r.expando]
        ? (s = e[r.expando])
        : ((s = r.count++), (e[r.expando] = s), (r.events[s] = {})),
        (o = o || e);
      const g = t.split(" ");
      for (i = g.length; i--; )
        (l = g[i]),
          ...
          r.domLoaded && "ready" === l && "complete" === e.readyState
            ...
            : (r.hasMouseEnterLeave ||
              ...
              a
                ...
                : ((r.events[s][l] = a = [{ func: n, scope: o }]),
                  (a.fakeName = d),
                  (a.capture = u),
                  (a.nativeHandler = c),
                  "ready" === l ? Ds(e, c, r) : Os(e, d || l, c, u)));
      return (e = a = null), n;
    }
    unbind(e, t, n) {
      let o, r, s, a, i;
        ...
        if (((i = this.events[l]), t)) {
          ...
          for (r = l.length; r--; )
            if (((a = l[r]), (o = i[a]), o)) {
              ...
              (n && 0 !== o.length) ||
                (delete i[a],
                Ts(e, o.fakeName || a, o.nativeHandler, o.capture));
            }
        } else
          fe(i, (t, n) => {
    ...
    clean(e) {
      ...
      if (
        ...
        for (
          this.unbind(e), n = e.getElementsByTagName("*"), t = n.length;
          t--;
  ...
  const Ls = Bt.each,
    ...
    Hs = (e, t = {}) => {
      ...
      const a = Xo.forElement(fn(e), {
        ...
        k = (e, n, o) => {
          P(e, (e) => {
            if (Co(e)) {
              ...
              const s = Kt(r, n),
                a = J[n];
              a && a.set ? a.set(r.dom, o, n) : Fs(r, n, o),
                s !== o &&
                  t.onSetAttrib &&
                  t.onSetAttrib({ attrElm: r, attrName: n, attrValue: o });
            }
          });
        },
        ...
        R = (e, n, o) => {
          const r = (e, t) =>
              m(e) ? e : x(e) ? (xe(js, t) ? e + "" : e + "px") : ge(e, r),
            s = (e, t, n) => {
              const o = Vs(t);
                ...
                C(n)
                  ...
                  : ((e, t) => {
                      const n = Zt(e)
                        ...
                        : ((e, t) => (j(en(e), t) ? nn(e, t) : tn(e, t)))(e, t);
                      rn(e);
                    })(o, e);
              });
            }
        ...
        W = (e) => {
          if (Co(e)) {
            const t =
              "a" === e.nodeName.toLowerCase() && !b(e, "href") && b(e, "id");
        ...
        Q = {
          ...
          select: (n, o) => {
            ...
            const a =
              null !==
                (s =
                  null !== (r = g(o)) && void 0 !== r ? r : t.root_element) &&
              void 0 !== s
                ? s
                : e;
          ...
          split: (e, t, n) => {
            ...
            if (e && t)
              return (
                a.setStart(e.parentNode, zs(e)),
                a.setEnd(t.parentNode, zs(t)),
                (o = a.extractContents()),
                (a = K()),
                a.setStart(t.parentNode, zs(t) + 1),
                a.setEnd(e.parentNode, zs(e) + 1),
                (r = a.extractContents()),
                (s = e.parentNode),
                s.insertBefore(Jr(Q, o), e),
                n ? s.insertBefore(n, e) : s.insertBefore(t, e),
                s.insertBefore(Jr(Q, r), e),
                z(e),
                n || t
              );
          },
    ...
    Qs = () => {
      const e = [],
        ...
        a = (e, n) => {
          ...
          !o ||
            (n && -1 === ("," + (n || "") + ",").indexOf("," + o + ",")) ||
            qs.ScriptLoader.add(t[e] + "/langs/" + o + ".js");
        },
        i = (e, t = "added") =>
  ...
  const Js = () => {
    ...
    ua = (e, t) =>
      Yt(e, "data-mce-bogus") || ur(e, '[data-mce-bogus="all"]', da(t)),
    ma = (e, t) => {
  ...
  const pa = (e) => {
      ...
      return {
        backwards: (e, t, r, s) => {
          ...
          return o(
            e,
            t,
            () => a.prev().map((e) => ({ container: e, offset: e.length })),
            r
          ).getOrNull();
        },
        forwards: (e, t, r, s) => {
          ...
          return o(
            e,
            t,
            () => a.next().map((e) => ({ container: e, offset: 0 })),
            r
          ).getOrNull();
        },
      };
    ...
    _a = (e, t) => {
      ...
      return (
        e.bottom - n < t.top ||
        (!(e.top > t.bottom) && Sa(t.top - e.bottom, e, t))
      );
    },
    Ea = (e, t) =>
      e.top > t.bottom || (!(e.bottom < t.top) && Sa(t.bottom - e.top, e, t)),
    Na = (e, t, n) => {
    ...
    Ka = (e) => {
      ...
      return (
        (t = n.length > 0 ? xa(n[0]) : xa(e.getBoundingClientRect())),
        !$a(e) && Ua(e) && Wa(t)
          ? ((e) => {
        ...
        n ||
          (n = ((e) => {
            const t = [],
              ...
              o = (e, o) => {
                ...
                if (o < e.data.length) {
                  ...
                  if (
                    Ta(e.data[o - 1]) &&
                    (r.setStart(e, o), r.setEnd(e, o + 1), !qa(r))
                  )
                    return n(Ga(Ka(r), !1)), t;
                }
                o > 0 &&
                  (r.setStart(e, o - 1),
                  r.setEnd(e, o),
            ...
            if (Ba(r))
              if (e.isAtEnd()) {
                const e = ja(r, s);
                Fa(e) && o(e, e.data.length),
                  Ma(e) && !Ua(e) && n(Ga(Ka(e), !1));
              } else {
                const a = ja(r, s);
                if ((Fa(a) && o(a, 0), Ma(a) && e.isAtEnd()))
                  return n(Ga(Ka(a), !1)), t;
  ...
  (Ya.fromRangeStart = (e) => Ya(e.startContainer, e.startOffset)),
    (Ya.fromRangeEnd = (e) => Ya(e.endContainer, e.endOffset)),
    (Ya.after = (e) => Ya(e.parentNode, za(e) + 1)),
    (Ya.before = (e) => Ya(e.parentNode, za(e))),
    (Ya.isAbove = (e, t) =>
      Pt(ie(t.getClientRects()), le(e.getClientRects()), _a).getOr(!1)),
    (Ya.isBelow = (e, t) =>
      Pt(le(t.getClientRects()), ie(e.getClientRects()), Ea).getOr(!1)),
    (Ya.isAtStart = (e) => !!e && e.isAtStart()),
    (Ya.isAtEnd = (e) => !!e && e.isAtEnd()),
    (Ya.isTextPosition = (e) => !!e && Ro(e.container())),
    (Ya.isElementPosition = (e) => !1 === Ya.isTextPosition(e));
  const Xa = (e, t) => {
    ...
    Qa = (e, t, n) => {
      Do(n)
        ? ((e, t, n) => {
            ...
            t.insertNode(n),
              o.each((t) => Xa(e, t.previousSibling)),
              r.each((t) => Xa(e, t.nextSibling));
          })(e, t, n)
        : ((e, t, n) => {
    ...
    ni = (e) =>
      e
        ? Oe(
            e.childNodes,
            (e, t) => (
              Za(t) && "BR" !== t.nodeName ? (e = e.concat(ni(t))) : e.push(t),
              e
            ),
            []
          )
    ...
    ri = (e) => {
      let t;
      return (
        (t = Ja(e) ? "text()" : e.nodeName.toLowerCase()),
        t +
          "[" +
          ((e) => {
            let t, n;
    ...
    si = (e, t) => {
      ...
      return (
        ...
        Ja(n)
          ? (r = ((e, t) => {
              for (; (e = e.previousSibling) && Ja(e); ) t += e.data.length;
              return t;
            })(n, o))
          : ((s = n.childNodes),
            o >= s.length
              ? ((r = "after"), (o = s.length - 1))
              : (r = "before"),
            (n = s[o])),
        i.push(ri(n)),
        (a = ((e, t, n) => {
      ...
      return s
        ? Ja(s)
          ? ((e, t) => {
              ...
              return (
                Ja(e) && t > e.data.length && (t = e.data.length), Ya(e, t)
              );
            })(s, parseInt(n, 10))
          : ((n = "after" === n ? ei(s) + 1 : ei(s)), Ya(s.parentNode, n))
        : null;
    },
    ii = Io,
    li = (e, t, n, o, r) => {
      ...
      for (
        Ro(s)
          ? i.push(
              n
                ? ((e, t, n) => {
                    let o, r;
                    for (
                      r = e(t.data.slice(0, n)).length, o = t.previousSibling;
                      o && Ro(o);
                      o = o.previousSibling
                    )
                      r += e(o.data).length;
          ...
          : ((l = s.childNodes),
            a >= l.length &&
              l.length &&
              ((d = 1), (a = Math.max(0, l.length - 1))),
            i.push(e.nodeIndex(l[a], n) + d));
        s && s !== c;
        s = s.parentNode
      )
    ...
    mi = (e, t) => {
      ...
      if (xr(e)) {
        if (
          (Ro(e) && Cr(e) && (e = e.parentNode), (n = e.previousSibling), ii(n))
        )
          return n;
      ...
      const a = ((e) =>
        mi(e.startContainer, e.startOffset) || mi(e.endContainer, e.endOffset))(
        s
      );
      return a
        ? ((r = a.tagName), { name: r, index: di(n.dom, r, a) })
        : ((e, t, n, o) => {
            const r = t.dom,
              s = li(r, e, n, o, !0),
              a = t.isForward(),
  ...
  const wi = (e) => "inline-command" === e.type || "inline-format" === e.type,
              ...
              ? ((e, t) => {
                  const n = t.container(),
                    o = ((e, t) => {
                      ...
                      .map((e) => (e < t.offset() ? Ya(n, t.offset() - 1) : t))
                      .getOr(t);
                  return Cd(e), o;
                })(e, t)
              : vd(e, t))(e, t),
    Cd = (e) => {
      fd(e) && xr(e) && (kr(e) ? e.removeAttribute("data-mce-caret") : pd(e)),
        gd(e) && (bd(e), 0 === e.data.length && pd(e));
    },
    wd = Io,
    xd = Uo,
    kd = Fo,
    ...
    zd = (e, t, n, o, r) => {
      ...
      if (Fd(t)) {
        ...
        for (; (e = Ud(s.prev.bind(s), r)); ) if (n(e)) return e;
      }
      if (Id(t)) {
        if (a && n((e = Ud(s.next.bind(s), !0)))) return e;
        for (; (e = Ud(s.next.bind(s), r)); ) if (n(e)) return e;
      }
      return null;
    },
    jd = (e, t) => {
    ...
    Yd = (e, t, n) => {
      ...
      if (Ro(a)) {
        ...
        if (Nr(a) && i >= a.data.length - 1)
          return 1 === e && ((o = s(a)), o) ? Kd(o) : n;
  ...
  const nc = Io,
    ...
    ic = (e) =>
      ...
      ((e) =>
        !!Ur(e) &&
        !0 !== Y(de(e.getElementsByTagName("*")), (e, t) => e || Or(t), !1))(e),
    lc = zr,
    dc = (e, t) =>
      e.hasChildNodes() && t < e.childNodes.length ? e.childNodes[t] : null,
    cc = (e, t) => {
      if (Id(e)) {
        if (ac(t.previousSibling) && !oc(t.previousSibling))
          return Ya.before(t);
    ...
    uc = (e, t, n) => {
      ...
      if (t.isEqual(Ya.after(n)) && n.lastChild) {
        if (
          ((a = Ya.after(n.lastChild)),
          Fd(e) && ac(n.lastChild) && rc(n.lastChild))
        )
          return sc(n.lastChild) ? Ya.before(n.lastChild) : a;
      } else a = t;
      const i = a.container();
      let l = a.offset();
      if (oc(i)) {
        ...
        if (Fd(e) && l > 0 && ((r = dc(i, l - 1)), ac(r)))
          return !ic(r) && ((s = zd(r, e, lc, r)), s)
            ? oc(s)
              ? Ya(s, s.data.length)
              : Ya.after(s)
            : oc(r)
            ? Ya(r, r.data.length)
            : Ya.before(r);
        if (Id(e) && l < i.childNodes.length && ((r = dc(i, l)), ac(r)))
          return sc(r)
            ? ((e, t) => {
                ...
                return n && ac(n)
                  ? oc(n)
                    ? Ya(n, 0)
                    : Ya.before(n)
                  : uc(tc.Forwards, Ya.after(t), e);
              })(n, r)
            : !ic(r) && ((s = zd(r, e, lc, r)), s)
            ? oc(s)
              ? Ya(s, 0)
              : Ya.before(s)
            : oc(r)
      ...
      if (
        ((Id(e) && a.isAtEnd()) || (Fd(e) && a.isAtStart())) &&
        ((o = zd(o, e, L, n, !0)), lc(o, n))
      )
        return cc(e, o);
      r = zd(o, e, lc, n);
      const d = Be(
      ...
      return !d || (r && d.contains(r))
        ? r
          ? cc(e, r)
          : null
        : ((a = Id(e) ? Ya.after(d) : Ya.before(d)), a);
    },
    mc = (e) => ({
    ...
    bc = (e, t, n) =>
      hc(e, t, n).bind((o) =>
        ...
        ((e, t, n) => {
          return e
            ? !pc(t, n) &&
                ((o = t), !(!Ya.isTextPosition(o) && Po(o.getNode()))) &&
                gc(t) &&
                fc(n)
            : !pc(n, t) && fc(t) && gc(n);
          var o;
    ...
    vc = (e, t, n, o) =>
      bc(e, t, n).bind((n) => (o(n) ? vc(e, t, n, o) : M.some(n))),
    yc = (e, t) => {
      const n = e ? t.firstChild : t.lastChild;
      return Ro(n)
        ? M.some(Ya(n, e ? 0 : n.data.length))
        : n
        ? Fr(n)
          ? M.some(e ? Ya.before(n) : Po((o = n)) ? Ya.before(o) : Ya.after(o))
          : ((e, t, n) => {
          ...
          "start" === t
            ? (l
                ? i.hasChildNodes()
                  ...
                  : Pc(i.nextSibling)
                  ? ((o = i.nextSibling), (r = 0))
                  : Pc(i.previousSibling)
                  ? ((o = i.previousSibling),
                    (r = i.previousSibling.data.length))
            ...
            : (l
                ? i.hasChildNodes()
                  ...
                  ? ((o = i.previousSibling),
                    (r = i.previousSibling.data.length))
                  : ((o = i.parentNode), (r = e.nodeIndex(i)))
                : (r = e.nodeIndex(i)),
              (d = o),
              (c = r)),
          !l)
    ...
    Ic = (e, t) => {
      ((e, t) => {
        ...
        if (t) {
          ...
          if (((e) => xe(e, "id"))(t))
            return ((e, t) => {
              ...
              return Pt(n, o.or(n), (n, o) => {
                const r = e.createRng();
                return (
                  r.setStart(Oc(e, n.container()), n.offset()),
                  r.setEnd(Oc(e, o.container()), o.offset()),
                  { range: r, forward: Ac(t) }
                );
              });
            })(n, t);
          if (Nc(t))
          ...
          if (((e) => xe(e, "rng"))(t))
            return M.some({ range: t.rng, forward: Ac(t) });
        }
        return M.none();
  ...
  const zc = (e) => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
    ...
    Xc = (e, t, n) => {
      ...
      if (
        ...
        let a;
        o < s.length
          ? ((r = s[o]), (a = new Qo(r, e.getParent(r, e.isBlock))))
          : ((r = s[s.length - 1]),
    ...
    Qc = (e, t, n) => {
      if (e) {
        ...
        for (e = n ? e : e[o]; e; e = e[o]) if (Co(e) || !eu(e)) return e;
      }
    },
    Jc = (e, t) => (
      Yc(t) && (t = t.nodeName),
    ...
    ou = (e, t) => (
      ("color" !== t && "backgroundColor" !== t) || (e = Gc(e)),
    ...
    su = (e, t) => {
      ...
      return (
        e.getParent(
          t,
          (t) => ((n = e.getStyle(t, "text-decoration")), n && "none" !== n)
        ),
        n
      );
    },
    ...
    yu = (e, t, n, o, r, s) => {
        ...
        l = (t, n, o) => {
          ...
          return M.from(
            l(
              t,
              n,
              (e, t) => (uu(e.parentNode) ? -1 : ((a = e), o(r, e, t))),
              i
            )
          );
        };
      return l(n, o, bu)
        .bind((e) =>
          s ? l(e.container, e.offset + (r ? -1 : 0), vu) : M.some(e)
        )
        .orThunk(() =>
    ...
    Cu = (e, t, n, o, r) => {
      ...
      for (let o = 0; o < s.length; o++)
        for (let r = 0; r < t.length; r++) {
          const a = t[r];
          if (
            (!C(a.collapsed) || a.collapsed === n.collapsed) &&
            lu(a) &&
            e.is(s[o], a.selector)
          )
            return s[o];
    ...
    wu = (e, t, n, o) => {
      ...
      if (
        (r && iu(i) && i.wrapper && (r = mu(s, r, "ul,ol").reverse()[0] || r),
        !r)
      )
    ...
    xu = (e, t, n, o) => {
      ...
      return (
        !C(n[o]) && (!(r !== t && !y(r) && !e.isBlock(r)) || xu(e, t, r, o))
      );
    },
    ku = (e, t, n, o, r) => {
      let s = n;
    ...
    _u = (e, t, n, o = !1) => {
      ...
      return (
        ...
        (du(d) || d.block_expand) &&
          ((du(d) && Ro(r) && 0 !== s) || (r = ku(l, n, r, s, !0)),
          (du(d) && Ro(a) && i !== a.nodeValue.length) ||
            (a = ku(l, n, a, i, !1))),
        cu(d) &&
          ((r = Cu(l, n, t, r, "previousSibling")),
          (a = Cu(l, n, t, a, "nextSibling"))),
        (iu(d) || lu(d)) &&
          ((r = wu(e, n, r, "previousSibling")),
          (a = wu(e, n, a, "nextSibling")),
          iu(d) &&
            (l.isBlock(r) || (r = ku(l, n, r, s, !0)),
            l.isBlock(a) || (a = ku(l, n, a, i, !1)))),
        ...
        ((e) => {
          ...
          return Ro(t)
            ? n === t.data.length
              ? M.some(fn(t))
              : M.none()
            : M.from(t.childNodes[n - 1]).map(fn);
        })(t),
        (t, n) => {
  ...
  const Ku = (e, t, n) =>
    ...
    em = {
      ...
      HOME: 36,
      modifierPressed: (e) =>
        e.shiftKey || e.ctrlKey || e.altKey || em.metaKeyPressed(e),
      metaKeyPressed: (e) =>
      ...
      const x = (e) => C(e) && (Lo(e) || n.is(e, "figure.image")),
        ...
        E = (e) => {
          ...
          return (
            ...
            e !== t.getBody() &&
            (n.hasClass(e, "mce-preview-object")
              ? hn(fn(e.firstElementChild), o)
              : hn(fn(e), o))
          );
        },
        N = (e, o, r) => {
        ...
        L = (o) => {
          ...
          if (
            ...
            if (P(t, a) && P(e.getEnd(!0), a))
              return n.setAttrib(a, tm, i), void B.throttle(a);
          }
          D();
        },
        M = () => {
    ...
    dm = (e, t, n) =>
      t(fn(n.startContainer), n.startOffset, fn(n.endContainer), n.endOffset);
  lm.ltr, lm.rtl;
  const cm = (e, t, n, o) => ({ start: e, soffset: t, finish: n, foffset: o }),
    um = document.caretPositionFromPoint
      ? (e, t, n) => {
          var o, r;
          return M.from(
    ...
    Am = (e, t, n, o, r) => {
      ...
      if (o && Po(r) && t && e.isEmpty(d))
        return M.some(Ya(r.parentNode, e.nodeIndex(r)));
      const c = new Qo(r, d);
      for (; (i = c[o ? "prev" : "next"]()); ) {
        if ("false" === e.getContentEditableParent(i) || Nm(i, a))
          return M.none();
        if (Ro(i) && i.nodeValue.length > 0)
          return !1 === Sm(i, a, "A")
            ? M.some(Ya(i, o ? i.nodeValue.length : 0))
            : M.none();
    ...
    Om = (e, t, n, o) => {
      ...
      if (
        (Co(r) && s > r.childNodes.length - 1 && (l = !1),
        Bo(r) && ((r = a), (s = 0)),
        r === a)
      ) {
        ...
        if (r.hasChildNodes()) {
          if (
            ((s = Math.min(!l && s > 0 ? s - 1 : s, r.childNodes.length - 1)),
            (r = r.childNodes[s]),
            (s = Ro(r) && c ? r.data.length : 0),
            !t && r === a.lastChild && _m(r))
          )
            return M.none();
          if (
            ((e, t) => {
        ...
        t &&
          ...
          Co(r) &&
            ...
            !i ||
              !Po(i) ||
              ((e, t) =>
                e.previousSibling && "A" === e.previousSibling.nodeName)(i) ||
              Rm(e, i, !1) ||
              Rm(e, i, !0) ||
              Am(e, c, t, !0, i).each((e) => {
                (r = e.container()), (s = e.offset()), (d = !0);
        ...
        t === o && Ro(t)
          ...
          : (Ro(t) &&
            ...
            Ro(o) &&
              r > 0 &&
              r < o.nodeValue.length &&
              ((o = Bm(o, r).previousSibling), (r = o.nodeValue.length))),
  ...
  (Pm.compareRanges = xm),
    (Pm.getCaretRangeFromPoint = wm),
    (Pm.getSelectedNode = Ra),
    (Pm.getNode = Aa);
  const Lm = ((e, t) => {
      const n = (t) => {
          const n = ((e) => {
  ...
  const Um = (e) => "textarea" === Mt(e),
    ...
    Hm = (e, t, n, o) => {
      ...
      const a = ((e, t) => {
        const n = ((e, t) => {
            const n = Rn(e);
            if (0 === n.length || Um(e)) return { element: e, offset: t };
            if (t < n.length && !Um(n[t])) return { element: n[t], offset: 0 };
            {
    ...
    Ym = (e, t, n, o) => {
      ...
      s.top < a.y
        ? po(n.element, !1 !== o)
        : s.top > a.bottom && po(n.element, !0 === o);
    },
    ...
    sf = (e) =>
      pm.range(
        e.start,
        rf(e.soffset, e.start),
        e.finish,
        rf(e.foffset, e.finish)
      ),
    ...
    mf = (e) =>
      (e.bookmark ? e.bookmark : M.none())
        .bind((t) => {
          return (
            (n = fn(e.getBody())), (o = t), M.from(o).filter(lf(n)).map(sf)
          );
          var n, o;
        })
        .bind(cf),
  ...
  const hf = Hs.DOM,
    bf = (e, t) => {
      const n = Nl(e),
        o = hf.getParent(
          t,
          (t) => ((e) => ff.isEditorUIElement(e))(t) || (!!n && e.dom.is(t, n))
        );
      return null !== o;
    },
    vf = (e, t) => {
        ...
        e.on("init", () => {
          e.inline &&
            ((e, t) => {
              ...
              Hs.DOM.bind(document, "mouseup", n),
                e.on("remove", () => {
    ...
    yf = (e, t) => {
      e.focusedEditor === t.editor && (e.focusedEditor = null),
        e.activeEditor || (hf.unbind(document, "focusin", pf), (pf = null));
    },
    Cf = (e, t) => {
      ((e, t) =>
        ((e) =>
          e.collapsed
            ? M.from(Aa(e.startContainer, e.startOffset)).map(fn)
            : M.none())(t).bind((t) =>
          ar(t) ? M.some(t) : !1 === yn(e, t) ? M.some(e) : M.none()
        ))(fn(e.getBody()), t)
        .bind((e) => xc(e.dom))
        .fold(
          () => {
      ...
      e.inline
        ? ((e) => {
            ...
            return (
              ...
              nf(n) ||
                ((o = n),
                of(Mn(o)).filter((e) => o.dom.contains(e.dom))).isSome())
            );
            var n, o;
          })(e)
        : ((e) => e.iframeElement && nf(fn(e.iframeElement)))(e),
  ...
  class Ff {
    ...
    insert(e, t, n) {
      ...
      return (
        n
          ? (t === o.firstChild ? (o.firstChild = e) : (t.prev.next = e),
            (e.prev = t.prev),
            (e.next = t),
            (t.prev = e))
          : (t === o.lastChild ? (o.lastChild = e) : (t.next.prev = e),
            (e.next = t.next),
            (e.prev = t),
            (t.next = e)),
        (e.parent = o),
    ...
    isEmpty(e, t = {}, n) {
      ...
      if (r)
        do {
          ...
          if (3 === r.type && r.parent && t[r.parent.name] && Vr(r.value))
            return !1;
          if (n && n(r)) return !1;
        } while ((r = Lf(r, o)));
      return !0;
  ...
  const Yf = ["font", "text-decoration", "text-emphasis"],
    ...
    tg = (e) => {
      ...
      return (
        Ro(t) &&
        (0 === t.data.length || (hr(t.data) && Wu.isBookmarkNode(t.parentNode)))
      );
    },
    ng = (e, t) => (n) =>
      M.from(Hd(e ? 0 : -1, n))
    ...
    rg = (e) =>
      Io(e) && !((e) => Co(e) && "all" === e.getAttribute("data-mce-bogus"))(e),
    sg = ng(!0, og),
    ag = ng(!1, og),
    ig = ng(!0, Uo),
    lg = ng(!1, Uo),
    ...
    yg = (e, t, n) =>
      bg(e, t.dom, n).forall((e) =>
        vg(t, n).fold(
          () => !1 === Vd(e, n, t.dom),
          (o) => !1 === Vd(e, n, t.dom) && yn(o, fn(e.container()))
        )
      ),
    Cg = (e, t, n) =>
      vg(t, n).fold(
        () => bg(e, t.dom, n).forall((e) => !1 === Vd(e, n, t.dom)),
        (t) => bg(e, t.dom, n).isNone()
      ),
    wg = O(Cg, !1),
    xg = O(Cg, !0),
    kg = O(yg, !1),
    ...
    Rg = (e, t) =>
      ((e) => M.from(e.getNode(!0)).map(fn))(t).exists(nr) ||
      Eg(!1, e, t).isSome(),
    Ag = O(Eg, !1),
    Og = O(Eg, !0),
    ...
    Lg = (e) =>
      Jd(e)
        .bind((e) => qo(e, Ut))
        .exists((e) =>
          ((e) => j(["pre", "pre-wrap"], e))(qn(e, "white-space"))
        ),
    ...
    Wg = (e, t) =>
      ((e, t) => {
        const n = e.container(),
          o = e.offset();
        return (
          !1 === Ya.isTextPosition(e) &&
          n === t.parentNode &&
          o > Ya.before(t).offset()
        );
      })(t, e)
        ? Ya(t.container(), t.offset() - 1)
        : t,
    Kg = (e) => {
      return Fr(e.previousSibling)
        ? M.some(
            ((t = e.previousSibling),
            Ro(t) ? Ya(t, t.data.length) : Ya.after(t))
          )
        : e.previousSibling
        ? kc(e.previousSibling)
        : M.none();
      var t;
    },
    Gg = (e) => {
      return Fr(e.nextSibling)
        ? M.some(((t = e.nextSibling), Ro(t) ? Ya(t, 0) : Ya.before(t)))
        : e.nextSibling
        ? xc(e.nextSibling)
        : M.none();
      var t;
        ...
        e
          ? ((e, t) =>
              Gg(t)
                ...
                .orThunk(() =>
                  ((e, t) =>
                    Cc(e, Ya.after(t)).fold(() => wc(e, Ya.before(t)), M.some))(
                    e,
                    t
                  )
                ))(t, n)
    ...
    tp = (e, t) => hn(fn(t), fl(e)),
    np = (e, t, n) => {
      const o = ((e, t, n) => K(Hs.DOM.getParents(n.container(), "*", t), e))(
        e,
        t,
        n
      );
    ...
    op = (e, t) => {
      ...
      return e
        ...
        ? Ro(n.previousSibling)
          ? Ya(n.previousSibling, n.previousSibling.data.length)
          : Ya.before(n)
        : _r(t)
        ? Ya(n, o - 1)
        : t;
    ...
    up = (e) => {
      var t;
      return (8 === It((t = e)) || "#comment" === Mt(t) ? Sn(e) : Tn(e))
        .bind(up)
        .orThunk(() => M.some(e));
    },
    mp = (e, t, n, o = !0) => {
      ...
      if (
        (Yr(s) && (fg(s), o && e.selection.setCursorLocation(s.dom, 0)),
        !vn(n, s))
      ) {
        const e = Dt(kn(s), n)
          ? []
    ...
    vp = (e, t) =>
      Ou(e.start, t).bind((n) => Ou(e.end, t).bind((e) => Lt(vn(n, e), n))),
    yp = (e) => (t) =>
      vp(t, e).map((e) =>
        ((e, t, n) => ({ rng: e, table: t, cells: n }))(t, e, fp(e))
      ),
    Cp = (e, t, n, o) => {
        ...
        const e = hp(n.startContainer, o),
          ...
          r = e
            .bind(
              (
                (e) => (t) =>
                  Ou(t, e).bind((e) => le(fp(e)).map((e) => gp(t, e)))
              )(o)
            )
            .bind(yp(o)),
          s = t
            .bind(
              (
                (e) => (t) =>
                  Ou(t, e).bind((e) => ie(fp(e)).map((e) => gp(e, t)))
              )(o)
            )
            .bind(yp(o));
    ...
    wp = (e, t) => J(e, (e) => vn(e, t)),
    xp = (e) =>
      Pt(wp(e.cells, e.rng.start), wp(e.cells, e.rng.end), (t, n) =>
        e.cells.slice(t, n + 1)
      ),
    kp = (e, t) => {
    ...
    Sp = (e, t) => {
      ...
      return ((e, t, n) =>
        ...
        ? o.map((e) => pp.singleCellTable(t, e.start))
        : r.isMultiTable
        ? ((e, t, n, o) =>
            Cp(e, t, n, o).bind(({ start: e, end: o }) => {
            ...
            Cp(e, t, n, o)
              ...
              .bind((e) => {
                ...
                if (o && e.cells.length === r.length)
                  return M.some(pp.fullTable(e.table));
                if (r.length > 0) {
                  if (o) return M.some(pp.partialTable(r, M.none()));
                  {
                    const e = kp(n, t);
                    return M.some(pp.partialTable(r, M.some({ ...t, rng: e })));
                  }
                }
                return M.none();
              }))(o, r, t, n);
        ...
        const o = e.selection.getRng(),
          r = n
            .bind(({ rng: n, isStartInTable: r }) => {
              const s = ((e, t) =>
                M.from(e.dom.getParent(t, e.dom.isBlock)).map(fn))(
                e,
              ...
              n.deleteContents(),
                ((e, t, n) => {
                  n.each((n) => {
                    t
                      ? no(n)
                      : (fg(n), e.selection.setCursorLocation(n.dom, 0));
                  });
                })(e, r, s.filter(Yr));
              const a = r ? t[0] : t[t.length - 1];
              return (
                Ep(e, a, o, r),
                Yr(a) ? M.none() : M.some(r ? t.slice(1) : t.slice(0, -1))
              );
            })
            .getOr(t);
        _p(r), Np(e);
      ...
      return Dp(o, n).fold(
        () =>
          ((e, t, n, o) => {
            ...
            return Bp(n, o).bind((o) =>
              Yr(o)
                ? Pp(e, o)
                : ((e, t, n, o, r) =>
                    bc(n, e.getBody(), r).bind((e) =>
                      Bp(t, fn(e.getNode())).bind((e) =>
                        vn(e, o) ? M.none() : M.some(S)
                      )
                    ))(e, n, t, o, r)
            );
          })(e, t, o, n).orThunk(() =>
            Lt(
              ((e, t) => {
                ...
                return (
                  Lp(t, n) || hc(t, e.getBody(), n).exists((e) => Lp(t, e))
                );
              })(e, t),
              S
            )
              ...
              : ((e, t, n, o) =>
                  Dp(t, o).fold(
                    () =>
                      ((e, t, n) =>
                        Sp(t, n).bind((t) =>
                          t.fold(O(Op, e), O(Tp, e), O(Rp, e), O(Ap, e))
                        ))(e, t, n),
                    (t) => ((e, t) => Pp(e, t))(e, t)
                  ))(e, o, r, t);
          })(e, n, o);
    ...
    Hp = (e, t, n, o) => {
      t.insert && n[o.name]
        ? o.empty().append(new Ff("br", 1))
        : (o.empty().append(new Ff("#text", 3)).value = fr);
    },
    $p = (e, t) =>
      e &&
      e.firstChild &&
        ...
        if (c && f.length > 1)
          if (t.isValidChild(c.name, d.name)) {
            ...
            qp(t, r, s, u)
              ...
              (c = f[0]),
              (qp(t, r, s, c) || $p(c, "br")) && c.empty().remove();
          } else Wp(d, t);
        else if (d.parent) {
          if ("li" === d.name) {
            let e = d.prev;
          ...
          return (
            ...
            (t.isEmpty(n) ||
              ((e, t) =>
                ...
                ((e) => e.firstChild && e.firstChild === e.lastChild)(t) &&
    ...
    Zp = (e, t, n, o) => {
      const r = ((e, t, n) => {
        ...
        a = Xp(
          ((i = r.firstChild), K(i.childNodes, (e) => "LI" === e.nodeName))
        );
      var i;
      const l = t.getRoot(),
        d = (e) => {
      ...
      return d(1)
        ...
        : d(2)
        ? ((e, t, n, o) => (o.insertAfter(t.reverse(), e), Jp(t[0], n)))(
            s,
            a,
            l,
            t
    ...
    nh = (e, t, n) => {
      ...
      -1 === t.indexOf("{$caret}") && (t += "{$caret}"),
        ...
        (r = a.getRng());
      const m =
          r.startContainer || (r.parentElement ? r.parentElement() : null),
        f = e.getBody();
      m === f &&
        a.isCollapsed() &&
        i.isBlock(f.firstChild) &&
        ((e, t) => t && !e.schema.getVoidElements()[t.nodeName])(
          e,
          f.firstChild
        ) &&
        i.isEmpty(f.firstChild) &&
        ((r = i.createRng()),
        r.setStart(f.firstChild, 0),
        r.setEnd(f.firstChild, 0),
        a.setRng(r)),
        a.isCollapsed() ||
          ((e) => {
            const t = e.dom,
            ...
            ((e, t, n) =>
              null !== n &&
              n === e.getParent(t.endContainer, th) &&
              Du(fn(n), t))(t, n, o)
              ? Op(e, n, fn(o))
      ...
      const g = { context: o.nodeName.toLowerCase(), data: n.data, insert: !0 },
        p = l.parse(t, g);
      if (!0 === n.paste && Yp(e.schema, p) && ((e, t) => !!Qp(e, t))(i, o))
        return (r = Zp(c, i, a.getRng(), p)), a.setRng(r), t;
      if (
        (!0 === n.paste &&
          ((e, t) => {
            ...
            return (
              n ===
                ("bookmark" === e.lastChild.attr("data-mce-type")
                  ? e.lastChild.prev
                  : e.lastChild) &&
              o &&
              r
      ...
      if ((e._selectionOverrides.showBlockCaretContainer(o), g.invalid)) {
        ...
        const n = e.getBody();
        for (9 === o.nodeType ? (o = s = n) : (s = o); s !== n; )
          (o = s), (s = s.parentNode);
        ...
        Kp(f, e.schema),
          Vp(l.getNodeFilters(), l.getAttributeFilters(), r),
          (t = c.serialize(r)),
          o === n ? i.setHTML(n, t) : i.setOuterHTML(o, t);
      } else
        (t = c.serialize(p)),
          ((e, t, n) => {
      ...
      return (
          ...
          if (t) {
            ...
            Bt.each(o.select("*[data-mce-fragment]"), (e) => {
              if (
                ...
                ((e, t) => te(Xf(e, t), (e) => !((e) => Gf.has(e))(e)))(o, e)
              )
                for (
                  let n = e.parentNode;
                  C(n) && n !== t && !Qf(o, e, n);
        ...
        ((e, t) => {
          ...
          if ("false" === o.getContentEditable(s))
            return o.remove(t), void r.select(s);
          let a = o.createRng();
        ...
        (h = e.getBody()),
        Bt.each(h.getElementsByTagName("*"), (e) => {
    ...
    sh = (e, t) =>
      ((e, t) => {
        const n = e.dom;
        return n.parentNode
          ? ((e, t) => Q(e.dom.childNodes, (e) => t(fn(e))).map(fn))(
              fn(n.parentNode),
              (n) => !vn(e, n) && t(n)
            )
          : M.none();
    ...
    ch = (e, t, n, o, r) => {
      ...
      return (
        ...
        ((t = e.dom.getParent(
          t,
          (t) => !!dh(e, t, n) || t.parentNode === s || !!fh(e, t, n, o, !0)
        )),
        !!fh(e, t, n, o, r))
      );
    },
      ...
      if (a)
        if (v(a.length)) {
          ...
          for (let n = 0; n < a.length; n++)
            if ("attributes" === o ? e.getAttrib(t, a[n]) : ru(e, t, a[n]))
              return !0;
      return !0;
    },
    fh = (e, t, n, o, r) => {
    ...
    Sh = (e, t, n, o) => {
      ...
      for (
        d = f,
          3 === f.nodeType &&
            (g !== f.nodeValue.length && (l = !0), (d = d.parentNode));
        d;
  ...
  const Ah = Bt.each,
    ...
    Wh = (e, t, n, o, r) => {
      let s;
      const a = e.dom;
      if (!uh(a, o, t) && !((e, t) => t.links && "A" === e.nodeName)(o, t))
        return Ih.keep();
      const i = o;
      if (du(t) && "all" === t.remove && p(t.preserve_attributes)) {
        const e = K(a.getAttribs(i), (e) =>
          j(t.preserve_attributes, e.name.toLowerCase())
        );
        if (
          (a.removeAllAttribs(i),
      ...
      if ("all" !== t.remove) {
        Uh(t.styles, (e, o) => {
          (e = ou(tu(e, n), o + "")),
            x(o) && ((o = e), (r = null)),
            (t.remove_similar || !r || zh(ru(a, r, o), e)) &&
              a.setStyle(i, o, ""),
            (s = !0);
        }),
          s &&
          ...
          Uh(t.attributes, (e, o) => {
            ...
            if (
              ((e = tu(e, n)),
              x(o) && ((o = e), (r = null)),
              t.remove_similar || !r || zh(a.getAttrib(r, o), e))
            ) {
              if (
                "class" === o &&
                (e = a.getAttrib(i, o)) &&
              ...
              if (
                (Fh.test(o) && i.removeAttribute("data-mce-" + o),
                "style" === o &&
                  wo(["li"])(i) &&
                  "none" === a.getStyle(i, "list-style-type"))
              )
                return (
                  i.removeAttribute(o),
        ...
        ? (((e, t, n) => {
            ...
            iu(n) &&
              ...
              ((n.list_block && zh(t, n.list_block)) ||
                $(de(t.childNodes), (t) => {
                  Zc(e, a, t.nodeName.toLowerCase())
                    ? r
                      ? r.appendChild(t)
                      : ((r = $h(s, t, a)), s.setAttribs(r, Vi(e)))
                    : (r = null);
                })),
              (((e) => lu(e) && du(e) && Dt(we(e, "mixed"), !0))(n) &&
                !zh(n.inline, t)) ||
                s.remove(t, !0);
          })(e, i, t),
          Ih.removed())
    ...
    Kh = (e, t, n, o, r) =>
      Wh(e, t, n, o, r).fold(P, (t) => (e.dom.rename(o, t), !0), L),
    Gh = (e, t, n, o) =>
      Wh(e, t, n, o, o).fold(
        N(o),
    ...
    Yh = (e, t, n, o, r) => {
      ...
      const l = e.dom,
        ...
        c = (o) => {
          const i = ((e, t, n, o, r) => {
            let s;
            return (
              $(au(e.dom, t.parentNode).reverse(), (t) => {
          ...
          return ((e, t, n, o, r, s, a, i) => {
            ...
            if (n) {
              ...
              for (let n = o.parentNode; n && n !== s; n = n.parentNode) {
                ...
                for (
                  let n = 0;
                  n < t.length && ((l = Gh(e, t[n], i, l)), null !== l);
                  n++
                );
        ...
        m = (t) => {
          ...
          Co(t) &&
            ...
            ((n = i), (i = "true" === l.getContentEditable(t)), (o = !0));
        ...
        f = (e) => {
          ...
          return (
            ((e) => Fc(e) && Co(e) && ("_start" === e.id || "_end" === e.id))(
              n
      ...
      if (o) {
        ...
        d.isCollapsed() && du(a) && !Au(e).length
          ? Sh(e, t, n, r)
          : (Iu(d, !0, () => {
              Mu(e, g);
            }),
            du(a) && gh(e, t, n, d.getStart()) && Xc(l, d, d.getRng()),
            e.nodeChanged()),
          Xu(e, t, o, n);
      else {
        o = d.getNode();
        for (
          let t = 0;
          t < s.length && (!s[t].ceFalseOverride || !Kh(e, s[t], n, o, o));
          t++
        );
        Xu(e, t, o, n);
      }
        ...
        f = (o, a, i) => {
          ...
          Eu(o, a, (a) => {
            ...
            const p = (a) => {
              ...
              if (
                (Co(a) &&
                  o.getContentEditable(a) &&
                  ((b = m), (m = "true" === o.getContentEditable(a)), (h = !0)),
                Po(a) &&
                  !((e, t, n, o) => {
                    if (El(e) && du(t)) {
                      const t = xs(e.schema),
                ...
                return (u = null), void (iu(s) && o.remove(a));
            ...
            $(l, (a) => {
              ...
              (!(l.length > 1) && o.isBlock(a)) || 0 !== i
                ? (du(s) || (iu(s) && s.wrapper)) &&
                  ...
                  ((e, t, n, o, r) => {
                    (fh(e, r.parentNode, n, o) && Kh(e, t, o, r)) ||
                  ...
                  ((e, t, n, o) => {
                    ...
                    t.styles &&
                      ...
                      (Bt.walk(o, r, "childNodes"), r(o));
                  })(o, s, 0, a),
                  ((e, t, n, o) => {
                    !du(t) ||
                      ("sub" !== t.inline && "sup" !== t.inline) ||
                      (Ph(o, Lh(e, "fontSize"), Mh(e, "fontSize", "")),
                      e.remove(
        ...
        const s = (n) => {
          ...
          if (n.state.get() !== a) {
            ...
            eb(n)
              ...
              : $(n.callbacks, (t) => t(a, { node: e, format: r, parents: o }));
          }
        };
  ...
  var Ib = hb([
    ...
    ov = function (e, t) {
      if ("object" !== sb(e) || "function" != typeof e.createPolicy)
        return null;
      var n = null,
    ...
    rv = (function e() {
      var t =
          arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : nv(),
        n = function (t) {
          return e(t);
        };
      if (
      ...
      var T,
        ...
        ke = function (e) {
          (Ce && Ce === e) ||
            ((e && "object" === sb(e)) || (e = {}),
            (e = Lb(e)),
            (z = "ALLOWED_TAGS" in e ? Pb({}, e.ALLOWED_TAGS) : j),
            (V = "ALLOWED_ATTR" in e ? Pb({}, e.ALLOWED_ATTR) : H),
            (ue =
              "ADD_URI_SAFE_ATTR" in e ? Pb(Lb(me), e.ADD_URI_SAFE_ATTR) : me),
            (de =
              "ADD_DATA_URI_TAGS" in e ? Pb(Lb(ce), e.ADD_DATA_URI_TAGS) : ce),
            (ie = "FORBID_CONTENTS" in e ? Pb({}, e.FORBID_CONTENTS) : le),
            (q = "FORBID_TAGS" in e ? Pb({}, e.FORBID_TAGS) : {}),
            (W = "FORBID_ATTR" in e ? Pb({}, e.FORBID_ATTR) : {}),
            ...
            ae &&
              ((z = Pb({}, db(Hb))),
              (V = []),
              !0 === ae.html && (Pb(z, Ib), Pb(V, $b)),
              !0 === ae.svg && (Pb(z, Fb), Pb(V, qb), Pb(V, Kb)),
              !0 === ae.svgFilters && (Pb(z, Ub), Pb(V, qb), Pb(V, Kb)),
              !0 === ae.mathMl && (Pb(z, jb), Pb(V, Wb), Pb(V, Kb))),
            e.ADD_TAGS && (z === j && (z = Lb(z)), Pb(z, e.ADD_TAGS)),
            e.ADD_ATTR && (V === H && (V = Lb(V)), Pb(V, e.ADD_ATTR)),
            e.ADD_URI_SAFE_ATTR && Pb(ue, e.ADD_URI_SAFE_ATTR),
            e.FORBID_CONTENTS &&
              (ie === le && (ie = Lb(ie)), Pb(ie, e.FORBID_CONTENTS)),
            re && (z["#text"] = !0),
            Q && Pb(z, ["html", "head", "body"]),
            z.table && (Pb(z, ["tbody"]), delete q.tbody),
            hb && hb(e),
            (Ce = e));
        },
      ...
      var Ae = function (e) {
        ...
        Te = function (e, t) {
          try {
            _b(n.removed, { attribute: t.getAttributeNode(e), from: t });
          } catch (e) {
            _b(n.removed, { attribute: null, from: t });
          }
        ...
        Ie = function (e) {
          ...
          if (
            ...
            e.hasChildNodes() &&
              ...
              Tb(/<[/\w]/g, e.innerHTML) &&
              Tb(/<[/\w]/g, e.textContent))
          )
            return Oe(e), !0;
          if ("select" === o && Tb(/<template/i, e.innerHTML)) return Oe(e), !0;
          if (!z[o] || q[o]) {
            if (!q[o] && Ue(o)) {
              if ($.tagNameCheck instanceof RegExp && Tb($.tagNameCheck, o))
                return !1;
          ...
          return e instanceof l && !Ae(e)
            ...
            : ("noscript" !== o && "noembed" !== o) ||
              !Tb(/<\/no(script|embed)/i, e.innerHTML)
            ? (X &&
                3 === e.nodeType &&
                ((t = e.textContent),
                (t = Rb(t, D, " ")),
                (t = Rb(t, P, " ")),
                e.textContent !== t &&
                  (_b(n.removed, { element: e.cloneNode() }),
                  (e.textContent = t))),
        ...
        Fe = function (e, t, n) {
          ...
          if (G && !W[t] && Tb(L, t));
            ...
            if (
              !(
                (Ue(e) &&
                  (($.tagNameCheck instanceof RegExp &&
                    Tb($.tagNameCheck, e)) ||
                    ($.tagNameCheck instanceof Function &&
                      $.tagNameCheck(e))) &&
                  (($.attributeNameCheck instanceof RegExp &&
                    Tb($.attributeNameCheck, t)) ||
        ...
        (n.sanitize = function (e, r) {
          ...
          if (
            ...
            if ("function" != typeof e.toString)
              throw Bb("toString is not a function");
            if ("string" != typeof (e = e.toString()))
              throw Bb("dirty is not a string, aborting");
          }
          if (!n.isSupported) {
            if (
              "object" === sb(t.toStaticHTML) ||
          ...
          return (
            Q &&
              ...
              Tb(tv, a.ownerDocument.doctype.name) &&
  ...
  let uv = 0;
  const mv = (e, t, n) =>
      lv(e).bind(({ data: e, type: o, base64Encoded: r }) => {
  ...
  class wv {
    constructor(e, t) {
      ...
      if (
        ...
        const t = this.settings.base_uri
          ? this.settings.base_uri.path
          : new wv(document.location.href).directory;
  ...
  const xv = Bt.makeMap,
    ...
    Nv = (e, t) => {
      ...
      let r = 0;
      return (
        n.addHook("uponSanitizeElement", (n, s) => {
          var a, i;
          8 === n.nodeType &&
            !e.allow_conditional_comments &&
            /^\[if/i.test(n.nodeValue) &&
          ...
          if (!o || f) {
            if (((s.allowedTags[l] = !0), o && !c)) {
              if (
                ($(
                  null !== (a = f.attributesForced) && void 0 !== a ? a : [],
                  (e) => {
                    qt(
                      d,
                      e.name,
                      "{$uid}" === e.value ? "mce_" + r++ : e.value
                    );
                  }
                ),
                $(
                  null !== (i = f.attributesDefault) && void 0 !== i ? i : [],
                  (e) => {
                    Yt(d, e.name) ||
                      qt(
                        d,
                ...
                f.attributesRequired &&
                  !V(f.attributesRequired, (e) => Yt(d, e)))
              )
                return void oo(d);
              if (
                f.removeEmptyAttrs &&
        ...
        n.addHook("uponSanitizeAttribute", (n, r) => {
          ...
          (r.keepAttr =
            !o || t.isValid(s, a) || ze(a, "data-") || ze(a, "aria-")),
            a in _v && Cv(e, i, s) && (r.keepAttr = !1),
            r.keepAttr
              ? ((r.allowedAttributes[a] = !0),
                a in t.getBoolAttrs() && (r.attrValue = a),
                e.allow_svg_data_urls &&
          ...
          parse: (e, n = {}) => {
            ...
            const [f, g] = ((e, t, n, o) => {
                const r = n.validate,
                  ...
                  i = kv(
                    xv("script,style,head,html,body,title,meta,param"),
                    t.getBlockElements()
                  ),
                  l = xs(t),
                  d = /[ \t\r\n]+/g,
                ...
                return [
                  ...
                  (e) => {
                    ...
                    if (1 === e.type) {
                      ...
                      if (r && n) {
                        ...
                        ((e) => {
                          ...
                          : n.paddEmpty &&
                            (r ||
                              ((e) =>
                                $p(e, "#text") && e.firstChild.value === fr)(
                                e
                              )) &&
                            Hp(0, o, i, e);
                      }
                      ...
                      let t = e.value;
                      (i[
                        null === (n = e.next) || void 0 === n ? void 0 : n.name
                      ] ||
                        f(e, !1)) &&
                        (t = t.replace(u, "")),
                        0 === t.length ? e.remove() : (e.value = t);
            ...
            if (
              (((e, t, n) => {
                const o = [];
                for (let n = e, r = n; C(n); r = n, n = n.walk())
                  $(t, (e) => e(n)),
    ...
    Ov = (e, t) => {
      ...
      if (oh(e)) {
        if (o.content !== n) {
          const t = Av({ validate: !1, forced_root_block: !1 }).parse(
            o.content,
            { context: e.name }
          );
          return { ...o, content: t };
    ...
    Tv = (e, t) => {
      if (t.no_events) return yi.value(t);
      {
        ...
        return n.isDefaultPrevented()
          ? yi.error(Ju(e, { content: "", ...n }).content)
          : yi.value(n);
      }
    },
    Bv = (e, t, n) =>
      n.no_events ? t : Ov(t, (t) => Ju(e, { ...n, content: t })).content,
    Dv = (e, t) => {
      if (t.no_events) return yi.value(t);
      {
        const n = Ov(t.content, (n) =>
          ((e, t) => e.dispatch("BeforeSetContent", t))(e, { ...t, content: n })
        );
        return n.isDefaultPrevented()
          ? (Qu(e, n), yi.error(void 0))
          : yi.value(n);
      }
    },
    Pv = (e, t, n) => {
      n.no_events || Qu(e, { ...n, content: t });
    },
    ...
    Zv = (e) => {
      const t =
        ((n = e.getBody()), K(H(de(n.childNodes), Xv), (e) => e.length > 0));
      var n;
      const o = ee(t, (t) => {
    ...
    iy = (e) => ({
      ...
      undoManager: {
        ...
        add: (t, n, o, r, s, a) =>
          ((e, t, n, o, r, s, a) => {
            const i = Zv(e);
            if (
              ((s = s || {}), (s = Bt.extend(s, i)), !1 === ry(o) || e.removed)
            )
              return null;
        ...
        undo: (t, n, o) =>
          ((e, t, n, o) => {
            let r;
            return (
              t.typing && (t.add(), (t.typing = !1), sy(t, !1, n)),
              o.get() > 0 &&
                (o.set(o.get() - 1),
                (r = t.data[o.get()]),
                ey(e, r, !0),
        ...
        hasUndo: (t, n) =>
          ((e, t, n) =>
            n.get() > 0 || (t.typing && t.data[0] && !oy(Zv(e), t.data[0])))(
            e,
            t,
            n
          ),
        ...
        transact: (e, t, n) =>
          ((e, t, n) => (ay(e, t), e.beforeChange(), e.ignore(n), e.add()))(
            e,
            t,
            n
          ),
      ...
      formatter: {
            ...
            return M.from(e.selection.getStart(!0))
              .bind((o) =>
                ih(
                  ...
                  (n) =>
                    ce(t, (t) =>
                      ((t, n) => (fh(e, t.dom, n) ? M.some(n) : M.none()))(n, t)
                    ),
                  n
                )
              )
        ...
        toggle: (t, n, o) =>
          ((e, t, n, o) => {
            const r = e.formatter.get(t);
            !gh(e, t, n, o) || ("toggle" in r[0] && !r[0].toggle)
              ? Zh(e, t, n, o)
              : Yh(e, t, n, o);
          })(e, t, n, o),
                ...
                e.set({}),
                  ...
                  t.on("FormatApply FormatRemove", (n) => {
                    const o = M.from(n.node)
                      .map((e) => (Yc(e) ? e : e.startContainer))
                      .bind((e) =>
                        Co(e) ? M.some(e) : M.from(e.parentElement)
                      )
                      .getOrThunk(() => tb(t));
                    rb(t, o, e.get());
                  });
      ...
      editor: {
        getContent: (t) =>
          ((e, t) =>
            M.from(e.getBody()).fold(
              N("tree" === t.format ? new Ff("body", 11) : ""),
              (n) =>
                ((e, t, n) => {
                  let o;
                  return (
                    "raw" === t.format
                      ? (o = Bt.trim(Vf(e.serializer, n.innerHTML)))
                      : "text" === t.format
                      ? ((o = br(n.innerText)), (o = "\n" === o ? "" : o))
                      : (o =
                          "tree" === t.format
        ...
        setContent: (t, n) =>
          ((e, t, n) =>
            M.from(e.getBody())
                      ...
                      if (0 === n.length || /^\s+$/.test(n)) {
                        ...
                        return (
                          e.schema.isValidChild(
                            ...
                            ? ((n = r), (n = e.dom.createHTML(s, Vi(e), n)))
                            : n || (n = r),
                          rh(e, n, o.no_selection),
                          { content: n, html: n }
                        );
                      }
                      {
                        "raw" !== o.format &&
                          (n = Kf({ validate: !1 }, e.schema).serialize(
              ...
              .getOr({ content: t, html: oh(n.content) ? "" : n.content }))(
            e,
            t,
            n
          ),
        ...
        addVisual: (t) =>
          ((e, t) => {
            const n = e.dom,
              o = C(t) ? t : e.getBody();
            v(e.hasVisual) && (e.hasVisual = zl(e)),
                    ...
                    M.from(e.selection.getRng())
                      .map((t) => {
                        const n = M.from(
                          ...
                          i = br(s.textContent);
                        if (
                          (e.dom.remove(s), Gv(i, 0) || Gv(i, i.length - 1))
                        ) {
                          const e = n.getOr(o),
                            t = Yv(e),
                            r = t.indexOf(a);
        ...
        (e) => (
          ...
          t.filter(zt).map((t) =>
            ((e, t, n, o) => {
              ...
              o
                ? (qg(r, s, !1, !o), n.setStart(s, a))
                : (qg(s, r, !1, !o), n.setEnd(s, a));
            })(e, t, n, o)
          )
        )
      ).orThunk(() => {
        const e = ((e, t) =>
          e.filter((e) => Wu.isBookmarkNode(e.dom)).bind(t ? _n : Sn))(t, o)
          .or(t)
          .filter(zt);
        return e.map((e) =>
          ((e, t) => {
            kn(e).each((n) => {
              ...
              t && Mg(n, Ya(o, 0))
                ? Hg(o, 0)
                : !t && Ig(n, Ya(o, o.length)) && $g(o, o.length);
            });
          })(e, o)
        );
      });
      ...
      const { selectorChangedWithUnbind: a } = ((e, t) => {
        ...
        c = () => {
          ...
          if (void 0 !== o.bookmark && !1 === xf(o)) {
            const e = mf(o);
            if (e.isSome())
              return e.map((e) => Rf(o, [e])[0]).getOr(c.createRange());
          }
          try {
            (n = d()) &&
              !yo(n.anchorNode) &&
          ...
          return (
            ...
            a.setStart &&
              ...
              a.collapsed &&
              ((i = e.getRoot()), a.setStart(i, 0), a.setEnd(i, 0)),
            r &&
              s &&
              (0 === l(a.START_TO_START, a, r) && 0 === l(a.END_TO_END, a, r)
                ? (a = s)
                : ((r = null), (s = null))),
            a
          );
        ...
        u = (e, t) => {
          let n;
          if (!((e) => !!e && py(e.startContainer) && py(e.endContainer))(e))
            return;
          const a = d();
          if (
            ...
            !1 === t &&
              a.extend &&
              (a.collapse(e.endContainer, e.endOffset),
          ...
          !e.collapsed &&
            ...
            n &&
              ...
              (a.anchorNode === e.startContainer &&
                a.focusNode === e.endContainer) ||
                a.setBaseAndExtent(n, 0, n, 1))),
        ...
        f = {
          ...
          setCursorLocation: (t, n) => {
            ...
            C(t) && C(n)
              ...
              : (Pu(e, r, o.getBody(), !0), u(r));
          },
          getContent: (e) =>
            ((e, t = {}) =>
              ((e, t, n) => cy(e).selection.getContent(t, n))(
                e,
          ...
          getNode: () =>
            ((e, t) => {
              ...
              return (
                ...
                3 === o.nodeType &&
                  3 === r.nodeType &&
                  ((o = o.length === s ? Nf(o.nextSibling, !0) : o.parentNode),
                  (r = 0 === a ? Nf(r.previousSibling, !1) : r.parentNode),
                  o && o === r))
                  ? o
                  : n && 3 === n.nodeType
                  ? n.parentNode
          ...
          getSelectedBlocks: (t, n) =>
            ((e, t, n, o) => {
              ...
              const s = [],
                a = e.getRoot();
              if (
                ((n = e.getParent(n || _f(a, t, t.collapsed), e.isBlock)),
                (o = e.getParent(o || Ef(a, t, t.collapsed), e.isBlock)),
                n && n !== a && s.push(n),
                n && o && n !== o)
              ) {
                r = n;
          ...
          getBoundingClientRect: () => {
            const e = c();
            return e.collapsed
              ? Ya.fromRangeStart(e).getClientRects()[0]
        ...
        })(s, e, o),
        {
          ...
          serialize: (n, a = {}) => {
            const i = { format: "html", ...a },
              l = ((e, t, n) =>
                ((e, t) =>
                  e && e.hasEventListeners("PreProcess") && !t.no_events)(e, n)
                  ? ((e, t, n) => {
                      let o;
                      const r = e.dom;
                      let s = t.cloneNode(!0);
    ...
    jy = (e, t, n) => {
      Gu(e, t, { message: n }), console.error(n);
    },
    Vy = (e, t, n) =>
      n
                    ...
                    return C(s)
                      ...
                      : ((o = t),
                        ze(o, "blob:")
                          ...
                          cv(t).then((o) =>
                            mv(o, !1, (n) => M.some(fv(e, t, n))).getOrThunk(n)
                          )
                        );
                  }
                  var o, r;
                  return ze(t, "data:")
                    ? gv(e, t).fold(n, (e) => Promise.resolve(e))
  ...
  const Yy = (e, t) => {
      ...
      const r = Ky(),
        ...
        d = (t, n) => {
          $(e.undoManager.data, (e) => {
            "fragmented" === e.type
              ? (e.fragments = H(e.fragments, (e) => l(e, t, n)))
                  ...
                  const a = H(n, (n, a) => {
                    ...
                    return (
                      n.status && Xi(e)
                        ...
                        : n.error &&
                          (n.error.remove &&
                            (d(l.getAttribute("src"), Nt.transparentSrc),
                            r.push(l),
                            (c = !0)),
                          ((e, t) => {
                            zy(
                              e,
                              Xs.translate(["Failed to upload image: {0}", t])
                            );
                          })(e, n.error.message)),
                      {
                        element: l,
    ...
    tC = {
      ...
      tablecellverticalalign: { styles: { "vertical-align": "%value" }, ...eC },
      tablecellbordercolor: { styles: { borderColor: "%value" }, ...eC },
      tablecellclass: { classes: ["%value"], ...eC },
      tableclass: { selector: "table", classes: ["%value"], ...Zy },
      tablecellborderstyle: { styles: { borderStyle: "%value" }, ...eC },
      tablecellborderwidth: { styles: { borderWidth: "%value" }, ...eC },
    },
    nC = N(tC),
    oC = Bt.each,
    rC = Hs.DOM,
    sC = (e, t) => {
      ...
      const s = (t && t.schema) || Ss({}),
        a = (e) => {
          ...
          return (
            ((e, t) => {
              t.classes.length && rC.addClass(e, t.classes.join(" ")),
        ...
        i = (e, t, n) => {
          ...
          const l = t.length > 0 && t[0],
            ...
            c = ((e, t) => {
              ...
              return (
                !(!r || !r.length) && (t && -1 !== Bt.inArray(r, t) ? t : r[0])
              );
            })(e, d);
          ...
          return (
            ...
            n &&
              (o || ((o = rC.create("div")), o.appendChild(e)),
              Bt.each(n, (t) => {
                const n = a(t);
                o.insertBefore(n, e);
              })),
    ...
    iC = (e, t) => {
      ...
      var d;
      l.length
        ? (l[0].name || (l[0].name = n), (n = t.selector), (o = sC(l, e)))
        : (o = sC([n], e));
      ...
      return (
        ...
        rC.setStyles(o, { position: "absolute", left: -65535 }),
        e.getBody().appendChild(o),
        (r = rC.getStyle(e.getBody(), "fontSize", !0)),
          ...
          if (
            !(
              ("background-color" === t &&
                ...
                ((n = rC.getStyle(e.getBody(), t, !0)),
                "#ffffff" === Gc(n).toLowerCase())) ||
              ("color" === t && "#000000" === Gc(n).toLowerCase())
            )
          ) {
            ...
            n = (e, o) => {
              e &&
                (m(e)
                  ? (p(o) || (o = [o]),
                    $(o, (e) => {
                      v(e.deep) && (e.deep = !lu(e)),
                        v(e.split) && (e.split = !lu(e) || du(e)),
                        v(e.remove) && lu(e) && !du(e) && (e.remove = "none"),
                        lu(e) &&
                          du(e) &&
          ...
          e.on("mouseup keydown", (t) => {
            ((e, t) => {
              ...
              wh(e, null, !1),
                (8 !== t && 46 !== t) ||
                  !n.isCollapsed() ||
                  n.getStart().innerHTML !== ph ||
                  wh(e, Ec(o, n.getStart())),
                (37 !== t && 39 !== t) || wh(e, Ec(o, n.getStart()));
            })(e, t.keyCode);
          });
        })(e),
        {
          ...
          match: (t, n, o, r) =>
            ((e, t, n, o, r) => cy(e).formatter.match(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          matchAll: (t, n) =>
            ((e, t, n) => cy(e).formatter.matchAll(t, n))(e, t, n),
          matchNode: (t, n, o, r) =>
            ((e, t, n, o, r) => cy(e).formatter.matchNode(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          formatChanged: (t, o, r, s) =>
            ((e, t, n, o, r, s) =>
              cy(e).formatter.formatChanged(t, n, o, r, s))(e, n, t, o, r, s),
          getCssText: O(iC, e),
        }
      );
    },
    ...
    cC = (e) => {
      const t = Js(),
        ...
        r = {
          ...
          add: (s, a) =>
            ((e, t, n, o, r, s, a) => cy(e).undoManager.add(t, n, o, r, s, a))(
              e,
              r,
              o,
              n,
          ...
          undo: () =>
            ((e, t, n, o) => cy(e).undoManager.undo(t, n, o))(e, r, n, o),
          ...
          hasUndo: () =>
            ((e, t, n) => cy(e).undoManager.hasUndo(t, n))(e, r, o),
          hasRedo: () =>
            ((e, t, n) => cy(e).undoManager.hasRedo(t, n))(e, r, o),
          transact: (t) =>
            ((e, t, n, o) => cy(e).undoManager.transact(t, n, o))(e, r, n, t),
          ignore: (t) => {
            ((e, t, n) => {
            ...
            e.on("init", () => {
              ...
              e.on("keydown", (e) => {
                ...
                !(s < 16 || s > 20) ||
                  ...
                  t.typing ||
                  a ||
                  (t.beforeChange(), sy(t, !0, n), t.add({}, e), o.set(!0));
              }),
              e.on("mousedown", (e) => {
                t.typing && r(e);
              }),
    ...
    kC = (e, t, n) => (
      ...
      ((e, t) =>
        yn(t, e)
          ...
          : M.none())(t, n).fold(O(wC, e, t, n), O(CC, e, t, n))
    ),
          ...
          n.collapsed
            ? ((e, t, n) => {
                const o = hC(e, Ya.fromRangeStart(n)),
                  r = o.bind((n) =>
                    hc(t, e, n.position).bind((n) =>
                      hC(e, n).map((n) =>
                        ((e, t, n) =>
                          Po(n.position.getNode()) && !1 === Yr(n.block)
                            ? yc(!1, n.block.dom)
                                .bind((o) =>
                                  o.isEqual(n.position)
                                    ? hc(t, e, o).bind((t) => hC(e, t))
                                    : M.some(n)
                                )
                                .getOr(n)
                            : n)(e, t, n)
    ...
    NC = (e) => {
      ...
      return ((e, t) => {
        ...
        return (
          !((e, t) => EC(e, t.startContainer) || EC(e, t.endContainer))(e, t) &&
          n &&
          o
        );
        ...
        : ((e, t) => {
            const n = t.getRng();
            return Pt(
              dp(e, fn(n.startContainer)),
              dp(e, fn(n.endContainer)),
              (o, r) =>
                !1 === vn(o, r)
                  ? M.some(() => {
                      n.deleteContents(),
    ...
    UC = (e) => {
      ...
      return (
        !t.collapsed &&
        (FC(e, !0).exists((e) => e.isEqual(Ya.fromRangeStart(t))) ||
          FC(e, !1).exists((e) => e.isEqual(Ya.fromRangeEnd(t))))
      );
    },
    zC = Ci([
      { remove: ["element"] },
        ...
        return (
          ...
          ((e, t, n, o) => {
            ...
            ? ((e, t, n, o) => {
                ...
                return dp(fn(e), fn(n.getNode()))
                  .map((e) => (Yr(e) ? zC.remove(e.dom) : zC.moveToElement(r)))
                  .orThunk(() => M.some(zC.moveToElement(r)));
              })(e, t, n, o)
            : (t && mg(n)) || (!1 === t && ug(n))
            ? M.some(zC.moveToPosition(o))
            : M.none()
        );
        var r;
      }),
          ...
          () =>
            ((e, t, n) => {
              const o = Yd(t ? 1 : -1, e, n),
                ...
                s = fn(e);
              return !1 === t && mg(r)
                ? M.some(zC.remove(r.getNode(!0)))
                : t && ug(r)
                ? M.some(zC.remove(r.getNode()))
                : !1 === t && ug(r) && Rg(s, r)
                ? Ag(s, r).map((e) => zC.remove(e.getNode()))
                : t && mg(r) && Ng(s, r)
                ? Og(s, r).map((e) => zC.remove(e.getNode()))
                : ((e, t, n) =>
                    ((e, t) => {
                      ...
                      ? ((e, t) =>
                          e && Io(t.nextSibling)
                            ? M.some(zC.moveToElement(t.nextSibling))
                            : !1 === e && Io(t.previousSibling)
                            ? M.some(zC.moveToElement(t.previousSibling))
                            : M.none())(t, n.getNode(!1 === t)).fold(
                          () => jC(e, t, n),
                          M.some
                        )
                      : jC(e, t, n).bind((t) =>
                          ((e, t, n) =>
                            n.fold(
                              (e) => M.some(zC.remove(e)),
                              (e) => M.some(zC.moveToElement(e)),
                              (n) =>
                                Vd(t, n, e)
                                  ? M.none()
                                  : M.some(zC.moveToPosition(n))
                            ))(e, n, t)
                        ))(e, t, r);
              ...
              (n) => () =>
                n.fold(
                  ((e, t) => (n) => (
                    e._selectionOverrides.hideFakeCaret(), Zg(e, t, fn(n)), !0
                  ))(e, t),
                  ((e, t) => (n) => {
                  ...
                  .fold(
                    () =>
                      M.some(() => {
                        var n;
                        (n = fn(e.getBody())),
                          $(na(n, ".mce-offscreen-selection"), no),
                          Zg(e, t, fn(e.selection.getNode())),
                          cp(e);
                      }),
                    () => M.some(S)
                  )
    ...
    WC = (e, t) =>
      e.selection.isCollapsed()
        ? ((e, t) => {
            const n = Ya.fromRangeStart(e.selection.getRng());
            return hc(t, e.getBody(), n)
              .filter((e) => (t ? sg(e) : ag(e)))
              .bind((e) => M.from(Hd(t ? 0 : -1, e)))
      ...
      e
        ? ((e) => {
            if (KC(e.previousSibling))
              return (
                YC(e.previousSibling) || e.previousSibling.appendData(pr),
                e.previousSibling
              );
        ...
        : ((e) => {
            if (KC(e.nextSibling))
              return (
                GC(e.nextSibling) || e.nextSibling.insertData(0, pr),
                e.nextSibling
              );
    ...
    ZC = O(QC, !1),
    ew = (e, t) =>
      Ro(e.container()) ? QC(t, e.container()) : QC(t, e.getNode()),
    tw = (e, t) => {
      const n = t.get();
    ...
    dw = (e, t, n) => {
      const o = sp(n);
      return lw(e, t, o).bind((e) =>
        wc(e, o).isNone() ? M.some(rw.start(e)) : M.none()
      );
    },
    cw = (e, t, n) => {
      const o = rp(n);
      return lw(e, t, o).bind((e) =>
        Cc(e, o).isNone() ? M.some(rw.end(e)) : M.none()
      );
    },
    uw = (e, t, n) => {
      const o = sp(n),
    ...
    mw = (e) => {
      return (
        !1 ===
        ((t = gw(e)),
        "rtl" === Hs.DOM.getStyle(t, "direction", !0) ||
          ((e) => ep.test(e))(t.textContent))
      );
      var t;
    },
    ...
    Cw = (e, t) =>
      e
        ? t.fold(_(M.some, rw.start), M.none, _(M.some, rw.after), M.none)
        : t.fold(M.none, _(M.some, rw.before), M.none, _(M.some, rw.end)),
    ww = (e, t, n) => {
      const o = e ? 1 : -1;
      return (
        t.setRng(Ya(n.container(), n.offset() + o).toRange()),
      ...
      for (; s; ) {
        ...
        if (Po(n.getNode(!1)))
          return t === tc.Forwards
            ...
            : { positions: kw(t, a), breakType: xw.Br, breakAt: M.some(n) };
        if (n.isVisible()) {
          if (e(s, n)) {
            const e = _w(0, t, s, n);
            return { positions: kw(t, a), breakType: e, breakAt: M.some(n) };
          }
          a.push(n), (s = n);
        } else s = n;
      }
  ...
  const Hw = (e, t, n, o, r, s) => {
      ...
      return (
        l(c),
        ((e, t, n, o) => {
          for (; (o = zd(o, e, zr, t)); ) if (n(o)) return;
        })(e, o, l, c),
        i
      );
    },
    ...
    Qw = (e, t, n, o, r, s) => {
      ...
      if (((g = o(a) ? a.getNode() : r(a) ? a.getNode(!0) : Ra(n)), g)) {
        const n = ((e, t, n, o) => {
          ...
          1 === e
            ? ((s = r.next), (a = Ea), (i = _a), (l = Ya.after(o)))
            : ((s = r.prev), (a = _a), (i = Ea), (l = Ya.before(o)));
          const m = u(l);
          do {
          ...
          .orThunk(() =>
            ((e, t, n, o, r) => {
              ...
              return hc(e, n, s)
                ...
                .fold(
                  () => o.map(hw),
                  (r) => fw(t, n, r).map(O(vw, e, t, n, s, r)).filter(O(yw, o))
                )
                .filter(mw);
            })(e, t, n, s, o)
          );
      ...
      return (
        e.on("NodeChange", (o) => {
          kl(e) &&
            (((e, t, n) => {
              const o = H(
                  na(fn(t.getRoot()), '*[data-mce-selected="inline-boundary"]'),
                  (e) => e.dom
                ),
                r = K(o, e),
                s = K(n, e);
    ...
    ux = (e, t, n, o) => {
      ...
      e.undoManager.ignore(() => {
        e.selection.setRng(
          ...
          ip(e),
          fw(s, r, Ya.fromRangeStart(e.selection.getRng()))
            .map(bw)
            .bind(cx(e, t))
            .each(D);
      }),
      ...
      if (e.selection.isCollapsed() && kl(e)) {
        ...
        return ((e, t, n, o) => {
          ...
          return a
            .bind((e) =>
              n
                ? e.fold(N(M.some(bw(e))), M.none, N(M.some(hw(e))), M.none)
                : e.fold(M.none, N(M.some(hw(e))), M.none, N(M.some(bw(e))))
            )
            .map(cx(e, t))
            .getOrThunk(() => {
              const i = bc(n, r, o),
        ...
        return !((e, t, n) =>
          Pt(xc(n), kc(n), (o, r) => {
            const s = op(!0, o),
              ...
              i = op(!1, t);
            return e
              ? Cc(n, i).exists((e) => e.isEqual(a) && t.isEqual(s))
              : wc(n, i).exists((e) => e.isEqual(s) && t.isEqual(a));
          }).getOr(!0))(t, o, n.dom) ||
          (_c((s = n).dom) && bh(s.dom))
          ? M.none()
          : M.some(() =>
    ...
    yx = (e, t) =>
      (e || "table" === Mt(t) ? "margin" : "padding") +
      ("rtl" === qn(t, "direction") ? "-right" : "-left"),
    Cx = (e) => {
      const t = xx(e);
      return (
        !e.mode.isReadOnly() &&
    ...
    xx = (e) => {
      return K(
        ((t = e.selection.getSelectedBlocks()), H(t, fn)),
        (e) =>
          !wx(e) &&
          !((e) => kn(e).exists(wx))(e) &&
          qo(e, (e) => Mo(e.dom) || Io(e.dom)).exists((e) => Mo(e.dom))
      );
      var t;
    },
    kx = (e, t) => {
    ...
    Ex = (e, t, n) =>
      ce([_x, qC, IC, (e, n) => mx(e, t, n), _C, Ip, WC, bx, RC, px], (t) =>
        t(e, n)
      ),
    Nx = (e, t) => {
      e.addCommand("delete", () => {
    ...
    Tx = (e, t) => {
      if (Ro(t)) {
        ...
        if (
          /^\s+$/.test(t.nodeValue) &&
          (!t.nextSibling || Ax(e, t.nextSibling))
        )
          return !0;
      }
      return !1;
    ...
    Bx = (e) => {
      ...
      if (
        ...
        ((e, t, n) => V(pg(fn(n), fn(t)), (t) => Ax(e, t.dom)))(r, a, s)
      )
        return;
      const m = n.getRng(),
        f = m.startContainer,
    ...
    Mx = (e, t) => {
      ...
      if (n)
        return "compositionstart" === t.type
          ? (t.preventDefault(), t.stopPropagation(), void Lx(e, n))
          : void (kr(n) && (Lx(e, n), e.undoManager.add()));
    },
    Ix = Io,
    Fx = (e, t, n) => {
    ...
    Ux = (e, t) =>
      ((e, t) => {
        const n = t ? tc.Forwards : tc.Backwards,
          o = e.selection.getRng();
        return ((e, t, n) => Xw(t, e, n, ug, mg, Ix))(n, e, o).orThunk(
          () => (Fx(e, n, o), M.none())
        );
    ...
    $x = (e, t) => {
      ...
      return ((e, t) => {
        ...
        if (
          ((e, t, n) =>
            t
              ? ((e, t) => Tw(e, t).breakAt.isNone())(e.dom, n)
              : ((e, t) => Ow(e, t).breakAt.isNone())(e.dom, n))(n, t, o)
        ) {
          const o = ((e, t, n, o) => {
            const r = un(n),
              s = un("br");
    ...
    nk = (e, t, n) =>
      ee(Rn(e), (e) => (hn(e, t) ? (n(e) ? [e] : []) : nk(e, t, n))),
    ok = (e, t) => Go(e, "table", t),
    rk = (e, t, n, o, r = L) => {
      const s = 1 === o;
    ...
    uk = (e, t, n) => {
      const o = e(t, n);
      return ((e) => e.breakType === xw.Wrap && 0 === e.positions.length)(o) ||
        (!Po(n.getNode()) &&
          ((e) => e.breakType === xw.Br && 1 === e.positions.length)(o))
          ...
          ((e, t) =>
            ie(t.getClientRects())
              ...
              .bind((e) => {
                return Aw(
                  kc((n = e))
                    .map((e) => Ow(n, e).positions.concat(e))
                    .getOr([]),
                  t
                );
                var n;
            ...
            .orThunk(() =>
              ie(n.getClientRects()).bind((n) =>
                Rw(Bw(e, Ya.before(t)), n.left)
              )
            )
            .getOr(Ya.before(t)))(a, n, s);
        return pk(e, t, o), !0;
      }
      if (t && fk(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            le(t.getClientRects())
              .bind((t) => ck(e, t.left, t.top))
              .bind((e) => {
                return Aw(
                  xc((n = e))
                    .map((e) => [e].concat(Tw(n, e).positions))
                    .getOr([]),
                  t
                );
                var n;
            ...
            .orThunk(() =>
              ie(n.getClientRects()).bind((n) => Rw(Dw(e, Ya.after(t)), n.left))
            )
            .getOr(Ya.after(t)))(a, n, s);
        return pk(e, t, o), !0;
      }
      return !1;
    },
      ...
      return ((e, t) =>
        ((e, t, n = P) =>
          n(t)
            ...
            : j(e, Mt(t))
            ? M.some(t)
            : Wo(t, e.join(","), (e) => hn(e, "table") || n(e)))(
          ["td", "th"],
          e,
          t
        ))(fn(t ? s.endContainer : s.startContainer), r)
        .map(
          (n) => (
            ok(n, r).each((t) => {
    ...
    Nk = (e, t, n) => {
      ...
      {
        const o = Ca(_k);
        return M.from(o.backwards(e, t, Ek(e), n)).map((e) =>
          Sk(e.container, e.container.data.length)
        );
      }
    },
    Rk = (e, t, n) => {
    ...
    Ak = (e, t, n) => {
      ...
      {
        const r = Ca(_k);
        return M.from(r.forwards(e, t, Ek(e), n)).bind((e) =>
          Ak(e.container, t - o.length, n)
        );
      }
    },
    Ok = (e, t, n, o, r) => {
    ...
    Pk = (e, t, n, o = 0) => {
      return ((r = fn(t.startContainer)), Go(r, Tf)).fold(
        () =>
          ((e, t, n, o = 0) => {
            ...
            return Ok(
              ...
              if (
                ...
                return M.none();
              const s = Tk(r);
              return 0 !== s.lastIndexOf(n) || Dk(s, n).length < o
                ? M.none()
                : M.some({ text: Dk(s, n), range: r, triggerChar: n });
            });
          })(e, t, n, o),
        (t) => {
          const o = e.createRng();
  ...
  const Uk = (e, t, n) => (e.stype === Fk.Error ? t(e.serror) : n(e.svalue)),
          ...
          e.fold(
            ...
            (e) => {
              ...
              return (
                ...
                (a = M.some),
                s.stype === Fk.Value
                  ? { stype: Fk.Value, svalue: a(s.svalue) }
                  : s
              );
              var s, a;
            }
    ...
    oS = (e, t, n) => {
      return (
        (o = ((e, t, n) =>
          ((e, t) =>
            e.stype === Fk.Error
              ? { stype: Fk.Error, serror: t(e.serror) }
              : e)(t.extract([e], n), (e) => ({ input: n, errors: e })))(
          e,
          t,
          n
        )),
        Uk(o, yi.error, yi.value)
      );
      var o;
    },
    rS = (e, t) => qk(e, ge(t, tS)),
    ...
    LS = tS([
      ...
      gS("ch"),
      yS("minChars", 1),
      (1, ((e, t) => uS(e, e, Gk(1), sS()))("columns")),
      yS("maxResults", 10),
      ("matches", hS("matches", cS)),
      SS,
      _S,
      ((MS = lS), vS("highlightOn", [], nS(MS))),
    ]);
  var MS;
  ...
  tS(
    [
      ...
      xS("initValue", N("")),
      OS,
      ((e, t) => uS(e, e, { tag: "required", process: {} }, nS(t)))(
        "commands",
        $S
      ),
      hS(
        "launch",
        rS("type", { contextformbutton: VS, contextformtogglebutton: HS })
      ),
    ].concat(US)
  );
  const qS = (e) => {
        ...
        a = (a) => {
          ((n) =>
            t
              .get()
              .map((t) =>
                Pk(e.dom, e.selection.getRng(), t.triggerChar).bind((t) =>
                  Ik(e, s, t, n)
                )
              )
              .getOrThunk(() =>
                ((e, t) => {
                  const n = t(),
                    o = e.selection.getRng();
                  return ((e, t, n) => ce(n.triggerChars, (n) => Pk(e, t, n)))(
                    e.dom,
                    o,
                    n
                  ).bind((n) => Ik(e, t, n));
    ...
    XS = (e, t) => {
      ...
      if (/^(LI|DT|DD)$/.test(t.nodeName)) {
        ...
        e &&
          ...
          t.insertBefore(r.doc.createTextNode(fr), t.firstChild);
      }
      const a = r.createRng();
      if ((t.normalize(), t.hasChildNodes())) {
        ...
        Po(t)
          ? t.nextSibling && r.isBlock(t.nextSibling)
            ? (a.setStartBefore(t), a.setEndBefore(t))
            : (a.setStartAfter(t), a.setEndAfter(t))
          : (a.setStart(t, 0), a.setEnd(t, 0));
      ...
      insert: (e, t) => {
        ...
        const u = e.dom,
          ...
          b = (t) => {
            ...
            if (
              ...
              u.setAttrib(n, "style", null), u.setAttrib(n, "class", null);
            else
              do {
                if (l[i.nodeName]) {
                  ...
                  (r = i.cloneNode(!1)),
                    u.setAttrib(r, "id", ""),
                    n.hasChildNodes()
                      ? (r.appendChild(n.firstChild), n.appendChild(r))
                      : ((a = r), n.appendChild(r));
                }
            ...
            for (
              ...
              if (Co(t)) {
                if (
                  ...
                  ((n = t.nodeName.toLowerCase()), g[n] && "br" !== n)
                )
                  return !1;
          ...
          C = () => {
            (a =
              /^(H[1-6]|PRE|FIGURE)$/.test(d) && "HGROUP" !== S ? b(h) : b()),
              ((e, t) => {
                const n = Ki(e);
                return (
                  !y(t) &&
                  (m(n) ? j(Bt.explode(n), t.nodeName.toLowerCase()) : n)
                );
              })(e, l) &&
              s_(u, l) &&
              u.isEmpty(s)
          ...
          (o = ((e, t, n, o, r) => {
            ...
            if (((a = u.getParent(o, u.isBlock)), !a || !s_(u, a))) {
              if (
                ...
                (c =
                  a === e.getBody() ||
                  ((e) => e && /^(TD|TH|CAPTION)$/.test(e.nodeName))(a)
        ...
        "LI" !== S || x || ((s = l), (l = l.parentNode), (d = S)),
          /^(LI|DT|DD)$/.test(d) && u.isEmpty(s)
            ? ((e, t, n, o, r) => {
                ...
                if (t_(n, o, !0) && t_(n, o, !1))
                  ...
                  ((e, t) => e.firstChild && "LI" === e.firstChild.nodeName)(t)
                    ? ((l = t.firstChild), s.insertAfter(t, n))
                    : (s.insertAfter(t, n), s.insertAfter(l, n)),
                    s.remove(o);
                }
                XS(e, l);
              })(e, b, l, s, h)
            : s !== e.getBody() &&
              (Cr(s)
                ? ((a = Rr(s)), u.isEmpty(s) && o_(s), l_(e, a), XS(e, a))
                : v()
                ? C()
                : v(!0)
                ...
                : ((n = ((e) => {
                    ...
                    return (
                      t.setStart(
                        e.startContainer,
                        a_(!0, e.startContainer, e.startOffset)
                      ),
                      t.setEnd(
                        e.endContainer,
                        a_(!1, e.endContainer, e.endOffset)
                      ),
                      t
                    );
                  })(p).cloneRange()),
                  ...
                  u.isEmpty(s) && o_(s),
                  a.normalize(),
                  u.isEmpty(a) ? (u.remove(a), C()) : (l_(e, a), XS(e, a))),
              u.setAttrib(a, "id", ""),
    ...
    x_ = (e, t) => (n, o) => {
      const r =
        ((e) => QS(e).fold(N(""), (e) => e.nodeName.toUpperCase()))(n) ===
        e.toUpperCase();
      return r === t;
    },
    k_ = (e) => x_("pre", e),
    ...
    A_ = (e, t, n) => {
      t.selection.isCollapsed() || ip(t),
        (C(n) && YS(t, e.fakeEventName).isDefaultPrevented()) ||
          (e.insert(t, n), C(n) && GS(t, e.fakeEventName));
    },
    O_ = (e, t) => {
      const n = () => A_(b_, e, t),
        o = () => A_(d_, e, t),
        r = ((e, t) =>
          ow(
            [
              R_([C_], y_.none()),
              R_([x_("summary", !0)], y_.br()),
              R_([k_(!0), S_(!1), E_], y_.br()),
              R_([k_(!0), S_(!1)], y_.block()),
              R_([k_(!0), S_(!0), E_], y_.block()),
              R_([k_(!0), S_(!0)], y_.br()),
              R_([w_(!0), E_], y_.br()),
              R_([w_(!0)], y_.block()),
              R_([__], y_.br()),
    ...
    P_ = (e, t, n) => {
      n && !e.get()
        ? t.on("NodeChange", B_, !0)
        : !n && e.get() && t.off("NodeChange", B_),
        e.set(n);
    },
    L_ = (e, t) => {
      const n = t.container(),
        o = t.offset();
      return Ro(n)
        ? (n.insertData(o, e), M.some(Ya(n, o + e.length)))
        : Jd(t).map((n) => {
            const o = mn(e);
    ...
    F_ = (e, t) => (n) =>
      ((e, t) =>
        !Lg(t) &&
        (((e, t) =>
          ((e, t) => wc(e.dom, t).isNone())(e, t) ||
          ((e, t) => Cc(e.dom, t).isNone())(e, t) ||
          wg(e, t) ||
          xg(e, t) ||
          Rg(e, t) ||
          Ng(e, t))(e, t) ||
    ...
    U_ = (e) => {
      ...
      if (e.selection.isCollapsed()) {
        ...
        return fw(o, e.getBody(), r)
          .bind(
            (
              (e) => (t) =>
                t.fold(
                  (t) => wc(e.dom, Ya.before(t)),
                  (e) => xc(e),
                  (e) => kc(e),
                  (t) => Cc(e.dom, Ya.after(t))
                )
            )(n)
          )
          .map(
    ...
    z_ = (e) =>
      md(e)
        ? [
            { keyCode: em.TAB, action: Gx(kk, e, !0) },
            { keyCode: em.TAB, shiftKey: !0, action: Gx(kk, e, !1) },
          ]
        : [],
    j_ = (e) => {
      if ((e.addShortcut("Meta+P", "", "mcePrint"), WS(e), ly(e)))
        return Ws(null);
      {
        const t = ax(e);
        return (
            ...
            e.on("keydown", (n) => {
              !1 === n.isDefaultPrevented() &&
                ((e, t, n) => {
                  ...
                  Yx(
                    [
                      { keyCode: em.RIGHT, action: Gx(Ux, e, !0) },
                      { keyCode: em.LEFT, action: Gx(Ux, e, !1) },
                      { keyCode: em.UP, action: Gx(zx, e, !1) },
                      { keyCode: em.DOWN, action: Gx(zx, e, !0) },
                      ...(o
                        ? [
                            {
                              keyCode: em.UP,
                        ...
                        : []),
                      { keyCode: em.RIGHT, action: Gx(vk, e, !0) },
                      { keyCode: em.LEFT, action: Gx(vk, e, !1) },
                      { keyCode: em.UP, action: Gx(yk, e, !1) },
                      { keyCode: em.DOWN, action: Gx(yk, e, !0) },
                      { keyCode: em.RIGHT, action: Gx(Qx, e, !0) },
                      { keyCode: em.LEFT, action: Gx(Qx, e, !1) },
                      { keyCode: em.UP, action: Gx(Jx, e, !1) },
                      { keyCode: em.DOWN, action: Gx(Jx, e, !0) },
                      { keyCode: em.RIGHT, action: Gx(rx, e, t, !0) },
                      { keyCode: em.LEFT, action: Gx(rx, e, t, !1) },
                      {
                        keyCode: em.RIGHT,
                        ctrlKey: !o,
                        altKey: o,
                      ...
                      { keyCode: em.UP, action: Gx(qx, e, !1) },
                      { keyCode: em.DOWN, action: Gx(qx, e, !0) },
                    ],
                    n
                  ).each((e) => {
                    n.preventDefault();
          ...
          ((e, t) => {
            e.on("keydown", (n) => {
              !1 === n.isDefaultPrevented() &&
                ((e, t, n) => {
                  const o =
                    n.keyCode === em.BACKSPACE
                      ? "deleteContentBackward"
                      : "deleteContentForward";
                  Xx(
                    [
                      { keyCode: em.BACKSPACE, action: Gx(_x, e) },
                      { keyCode: em.BACKSPACE, action: Gx(qC, e, !1) },
                      { keyCode: em.DELETE, action: Gx(qC, e, !0) },
                      { keyCode: em.BACKSPACE, action: Gx(IC, e, !1) },
                      { keyCode: em.DELETE, action: Gx(IC, e, !0) },
                      { keyCode: em.BACKSPACE, action: Gx(mx, e, t, !1) },
                      { keyCode: em.DELETE, action: Gx(mx, e, t, !0) },
                      { keyCode: em.BACKSPACE, action: Gx(Ip, e, !1) },
                      { keyCode: em.DELETE, action: Gx(Ip, e, !0) },
                      { keyCode: em.BACKSPACE, action: Gx(WC, e, !1) },
                      { keyCode: em.DELETE, action: Gx(WC, e, !0) },
                      { keyCode: em.BACKSPACE, action: Gx(bx, e, !1) },
                      { keyCode: em.DELETE, action: Gx(bx, e, !0) },
                      { keyCode: em.BACKSPACE, action: Gx(RC, e, !1) },
                      { keyCode: em.DELETE, action: Gx(RC, e, !0) },
                      { keyCode: em.BACKSPACE, action: Gx(_C, e, !1) },
                      { keyCode: em.DELETE, action: Gx(_C, e, !0) },
                      { keyCode: em.BACKSPACE, action: Gx(px, e, !1) },
                      { keyCode: em.DELETE, action: Gx(px, e, !0) },
                    ],
                    n
                  ).each((t) => {
                    n.preventDefault(),
                      YS(e, o).isDefaultPrevented() || (t(), GS(e, o));
                  });
                })(e, t, n);
            }),
              e.on("keyup", (t) => {
                !1 === t.isDefaultPrevented() &&
                  ((e, t) => {
                    Yx(
                      [
                        { keyCode: em.BACKSPACE, action: Gx($C, e) },
          ...
          ((e) => {
            e.on("keydown", (t) => {
              !1 === t.isDefaultPrevented() &&
                ((e, t) => {
                  Xx([{ keyCode: em.SPACEBAR, action: Gx(U_, e) }], t).each(
                    (n) => {
                      t.preventDefault(),
                        YS(e, "insertText", {
                          data: " ",
                        }).isDefaultPrevented() ||
                          (n(), GS(e, "insertText", { data: " " }));
                    }
                  );
                })(e, t);
            });
            ...
            e.on("input", (t) => {
              !1 === t.isComposing &&
                ((e) => {
                  const t = fn(e.getBody());
                  e.selection.isCollapsed() &&
                    jg(t, Ya.fromRangeStart(e.selection.getRng())).each((t) => {
                      e.selection.setRng(t.toRange());
                    });
                })(e);
            });
            ...
            e.on("keydown", (n) => {
              !1 === n.isDefaultPrevented() &&
                ((e, t, n) => {
                  ...
                  Yx(
                    [
                      { keyCode: em.END, action: Gx(jx, e, !0) },
                      { keyCode: em.HOME, action: Gx(jx, e, !1) },
                      ...(o
                        ? []
                        : [
                            {
                      ...
                      { keyCode: em.END, action: Gx(Zx, e, !0) },
                      { keyCode: em.HOME, action: Gx(Zx, e, !1) },
                      { keyCode: em.END, action: Gx(dx, e, !0, t) },
                      { keyCode: em.HOME, action: Gx(dx, e, !1, t) },
                    ],
                    n
                  ).each((e) => {
                    n.preventDefault();
              ...
              e.on("keyup", (o) => {
                !1 === o.isDefaultPrevented() &&
                  ((e, t, n) => {
                    Yx(
                      [
                        { keyCode: em.PAGE_UP, action: Gx(dx, e, !1, t) },
                        { keyCode: em.PAGE_DOWN, action: Gx(dx, e, !0, t) },
                      ],
                      n
                    );
                  })(e, t, o),
                  D_(o) && n.get() && (P_(n, e, !1), e.nodeChanged());
              });
          })(e, t),
          t
        );
  ...
  const H_ = N("x-tinymce/html"),
    ...
    oE = (e, t, n) =>
      !!((e, t) =>
        tE(t) && V(ud(e), (e) => je(t.toLowerCase(), `.${e.toLowerCase()}`)))(
        e,
        t
      ) &&
      ((e, t, n) => (
      ...
      if (Ql(e) && o) {
        ...
        if (s.length > 0)
          return (
            ...
            ((r = s),
            Promise.all(
              H(r, (e) => cv(e).then((t) => ({ file: e, uri: t })))
            )).then((t) => {
    ...
    fE = (e, t, n) => {
      ((e, t, n) => {
        ...
        e.on("keydown", (e) => {
          ((e) =>
            (em.metaKeyPressed(e) && 86 === e.keyCode) ||
          ...
          e.on("paste", (r) => {
            ...
            (!cE(a) && uE(e, r, t.getLastRng() || e.selection.getRng())) ||
              (dE(a, "text/html")
                ? (r.preventDefault(), mE(e, a, a["text/html"], s))
                : (t.create(),
                  gf.setEditorTimeout(
                    e,
                    () => {
    ...
    hE = (e) => ({
      html: q_(e.selection.getContent({ contextual: !0 })),
    ...
    vE = (e, t) => {
      var n, o;
      return Pm.getCaretRangeFromPoint(
              ...
              Xl(e) &&
                ...
                Ql(e) ||
                  e.on("drop", (e) => {
                    ...
                    t &&
                      ((e) => V(e.files, (e) => /^image\//.test(e.type)))(t) &&
                      e.preventDefault();
                  }),
                e.on("drop", (n) => {
    ...
    OE = (e) => {
      const t = ((e, t) => {
        const n = Ya.fromRangeStart(e).getNode(),
          o = ((e, t) =>
            qo(fn(e), (e) => ((e) => Mo(e.dom))(e) || er(e), NE(t)).getOr(fn(t))
              .dom)(n, t),
          r = AE(n, o, !1),
          s = AE(n, o, !0),
  ...
  const BE = (e, t) => Math.abs(e.left - t),
            ...
            s
              ...
              .orThunk(() => {
                ...
                return (
                  vn(t, e)
                    ? M.none()
                    : ((n = t), M.from(n.dom.parentElement).map(fn))
                ).bind((e) => r(e, M.some(t)));
              });
          return r(t, M.none());
        })(o, s, t, n);
      ...
      const t = Js(),
        ...
        s = ((e, t) => {
          ...
          return (
            ...
            (o) =>
              e.on((e) => {
                const r = Math.max(
                  Math.abs(o.screenX - e.screenX),
                  Math.abs(o.screenY - e.screenY)
                );
                if (!e.dragging && r > 10) {
                  if (
                    t
                ...
                if (e.dragging) {
                  const r = ((e, t) => ({
                    ...
                    ((e, t) => {
                      return (
                        (n = ((e) =>
                          e.inline ? FE(e.getBody()) : { left: 0, top: 0 })(e)),
                        (o = ((e) => {
                          const t = e.getBody();
                          return e.inline
        ...
        a = ((e, t) => (n) => {
          e.on((e) => {
            if (e.dragging) {
              if (
                ((e, t, n) => t !== n && !e.dom.isChildOf(t, n) && !UE(t))(
                  t,
                  ((e) => {
    ...
    KE = (e) => {
      ...
      const d = (e) => e !== r && (qE(e) || Uo(e)) && n.isChildOf(e, r),
        c = (n, o, r, a = !0) =>
          e
            .dispatch("ShowCaret", { target: o, direction: n, before: r })
            .isDefaultPrevented()
            ? null
            : (a && t.scrollIntoView(o, -1 === n), s.show(r, o)),
        u = (e) => xr(e) || Er(e) || Nr(e),
            ...
            if (d(o))
              return ((o) => {
                ...
                const d = ((o, r) => {
                  ...
                  c = fn(o);
                return (
                  $(na(fn(e.getBody()), "*[data-mce-selected]"), (e) => {
                    vn(c, e) || Xt(e, i);
                  }),
      ...
      return (
        ly(e) ||
          ...
          e.on(
            ...
            (t) => {
              const n = t.target,
                o = WE(e, n);
              qE(o)
                ? (t.preventDefault(), BC(e, o).each(g))
                : d(n) && BC(e, n).each(g);
            },
            !0
          ),
          e.on("mousedown", (o) => {
            ...
            const a = WE(e, s);
            qE(a)
              ? (o.preventDefault(), BC(e, a).each(g))
              : IE(r, o.clientX, o.clientY).each((n) => {
                  var r;
                  o.preventDefault(),
                    (r = c(1, n.node, n.position === TE.Before, !1)) &&
                      t.setRng(r),
                  ...
                  const t = (t) => {
                      if (!t.isDefaultPrevented()) {
                        ...
                        n &&
                          ...
                          (t.preventDefault(),
                          "drop" === t.type &&
                            zy(e, "Dropped file type is not supported"));
                      }
                    },
                    n = (n) => {
                      bf(e, n.target) && t(n);
              ...
              e.on("focusin", (t) => {
                ...
                if (Uo(n)) {
                  ...
                  e.selection.getNode() !== o &&
                    BC(e, o).each((t) => e.selection.setRng(t));
                }
              });
            });
          })(e)),
    ...
    QE = (e, t) =>
      XE(e, t.start).bind(({ node: n, offset: o }) =>
        XE(e, t.end).map(({ node: e, offset: t }) => {
          const r = document.createRange();
    ...
    tN = (e, t, n) => {
      ((e, t, n) => {
        ...
        {
          const t = Ca(_k);
          return M.from(t.forwards(e, 0, Ek(e), n)).map((e) =>
            Sk(e.container, 0)
          );
        }
      })(t, 0, t).each((o) => {
      ...
      return Ok(
        ...
        }
        {
          ...
          return Rk(o.container, s, n)
            ...
            .orThunk(() => iN(e, t, n, Sk(o.container, 0)));
        }
      });
    },
    lN = (e, t, n) => {
      ...
      return Rk(a, i - n.pattern.end.length, t).bind((l) => {
        ...
        if (aN(s))
          return M.some({
            matches: [{ pattern: s, startRng: d, endRng: d }],
            position: l,
          });
        {
              ...
              return Nk(n, o, r).bind((n) =>
                iN(e, t, r, n).bind((e) => {
                  if (s) {
                    ...
                    if (
                      0 === n.offset &&
                      e.endContainer.textContent.length === e.endOffset
                    )
                      return M.none();
                  }
                  return M.some(e);
    ...
    fN = (e, t) => {
      if (
        !e.selection.isCollapsed() ||
        !((e) => e.inlinePatterns.length > 0 || e.blockPatterns.length > 0)(t)
      )
        return !1;
            ...
            .bind((e) => {
              const o = e.textContent,
                r = ((e, t) => {
                  ...
                  return Q(
                    e,
                    (e) => 0 === t.indexOf(e.start) || 0 === n.indexOf(e.start)
                  );
                })(t, o);
              return r.map((t) =>
                Bt.trim(o).length === t.start.length
                  ? []
                  : [{ pattern: t, range: YE(n.getRoot(), e, 0, e, 0) }]
              );
            })
            .getOr([]);
        })(e, t.blockPatterns);
              ...
              ((e, t) => {
                ...
                $(t, (t) =>
                  ((e, t) => {
                    const n = e.dom,
                      o = t.pattern,
                      r = QE(n.getRoot(), t.range).getOrDie(
            ...
            e.execCommand("mceInsertNewLine"),
              r.each((t) => {
                ...
                n.data.charAt(t.offset - 1) === mr &&
                  ...
                  JE(e.dom, n.parentNode, (t) => t === e.dom.getRoot()));
              });
          }
        ),
        !0)
    ...
    hN = (e) => {
      ...
      e.on(
        ...
        (t) => {
          var n;
          13 !== t.keyCode ||
            em.modifierPressed(t) ||
            (fN(
              e,
              ((n = id(e)), { inlinePatterns: _i(n), blockPatterns: Si(n) })
            ) &&
              t.preventDefault());
        },
        !0
        ...
        e.on("keyup", (t) => {
          pN(n, t, (e, t) => e === t.keyCode && !1 === em.modifierPressed(t)) &&
            gN(e, o());
        }),
        e.on("keypress", (n) => {
          pN(t, n, (e, t) => e.charCodeAt(0) === t.charCode) &&
            gf.setEditorTimeout(e, () => {
              gN(e, o());
            });
        });
          ...
          : (e.on("keydown", (t) => {
              ...
              if (((o = a), n.collapsed && 0 === i)) {
                for (
                  ...
                  o &&
                  o.parentNode &&
                  o.parentNode.firstChild === o &&
                  o.parentNode !== l;

                )
                  o = o.parentNode;
                "BLOCKQUOTE" === o.tagName &&
                  (e.formatter.toggle("blockquote", null, o),
                  (n = r.createRng()),
                  n.setStart(a, 0),
                  n.setEnd(a, 0),
                  s.setRng(n));
            ...
            (() => {
              ...
              e.on("keydown", (s) => {
                ...
                if (!f(s) && (a === o || a === n)) {
                  ...
                  s.preventDefault(),
                    e.setContent(""),
                    l.firstChild && r.isBlock(l.firstChild)
                      ? e.selection.setCursorLocation(l.firstChild, 0)
                      : e.selection.setCursorLocation(l, 0),
                    e.nodeChanged();
                }
              });
            })(),
    ...
    _N = (e) => {
      !0 !== e.removed &&
        (((e) => {
          ly(e) || e.load({ initial: !0, format: "html" }),
    ...
    EN = (e) => {
      ...
      let n = e.getDoc();
      e.inline &&
        (vN.addClass(t, "mce-content-body"),
      ...
      (o.disabled = !0),
        ...
        e.readonly ||
          (e.inline &&
            "static" === vN.getStyle(o, "position", !0) &&
              ...
              for (; s--; )
                if (((o = t[s]), (r = o.attr(n)), r && !o.attr(i))) {
                  if (0 === r.indexOf("data:") || 0 === r.indexOf("blob:"))
                    continue;
                  "style" === n
                    ? ((r = a.serializeStyle(a.parseStyle(r), o.name)),
                      r.length || (r = null),
                      o.attr(i, r),
                      o.attr(n, r))
                    : "tabindex" === n
        ...
        (e.selection = hy(e.dom, e.getWin(), e.serializer, e)),
        (e.annotator = qu(e)),
        (e.formatter = lC(e)),
        (e.undoManager = cC(e)),
        (e._nodeChangeDispatcher = new V_(e)),
        (e._selectionOverrides = KE(e)),
        ((e) => {
          const t = Js(),
            n = Ws(!1),
            o = ea((t) => {
            ...
            r = (s, a) => {
              ...
              const i = e.getBody(),
                l =
                  !((e) =>
                    fC(e) &&
                    !(gC(e) || ("keyup" === e.type && 229 === e.keyCode)))(s) &&
                  ((e, t, n) => {
                    if (Yr(fn(t), !1)) {
              ...
              (("" !== t.getAttrib(i, mC)) !== l || a) &&
                (t.setAttrib(i, mC, l ? o : null),
          ...
          o &&
            e.on("init", (t) => {
              r(t, !0),
                ...
                e.on("paste", (t) => gf.setEditorTimeout(e, () => r(t)));
            });
        })(e),
        kE(e);
      const s = ((e) => {
      ...
      ((e) => {
        ...
        ((e) => {
          ...
          Gl(e) ||
            ((t.body.spellcheck = !1), vN.setAttrib(n, "spellcheck", "false")),
          (e.quirks = bN(e)),
          ((e) => {
    ...
    BN = (e) => {
      e.dispatch("ScriptsLoaded"),
        ...
        ((e) => {
          ...
          if (m(t)) {
            const n = Iy.get(t);
            (e.theme = n(e, Iy.urls[t]) || {}),
              w(e.theme.init) &&
                e.theme.init(
                  e,
                  Iy.urls[t] || e.documentBaseUrl.replace(/\/$/, "")
                );
          } else e.theme = {};
        })(e),
        ((e) => {
            ...
            ((e, t, n) => {
              ...
              if (((n = Bt.trim(n)), o && -1 === Bt.inArray(t, n))) {
                ...
                try {
                  ...
                  ((e, t, n) => {
                    const o = Xs.translate([
                      "Failed to initialize plugin: {0}",
                      t,
                    ]);
                    Gu(e, "PluginLoadError", { message: o }),
                      Hy(o, n),
                      zy(e, o);
                  })(e, n, t);
                }
          ...
          : ((e, t) => {
              ((e, t) => {
                ...
                (r.onload = () => {
                  ...
                  RN.add(t.iframeContainer, r);
              })(e, t),
                t.editorContainer &&
                  ((RN.get(t.editorContainer).style.display = e.orgDisplay),
                  (e.hidden = RN.isHidden(t.editorContainer))),
                (e.getElement().style.display = "none"),
                RN.setAttrib(e.id, "aria-hidden", "true"),
                NN(e);
            })(e, n)
      );
    },
    ...
    qN = (e, t, n, o, r) => {
      ...
      return ((e, t, n, o) => {
        const r = zN(n.forced_plugins),
          ...
          i = ((e, t, n, o) => (e && VN(t, "mobile") ? o : n))(
            e,
            t,
            s,
            a.plugins ? zN(a.plugins) : s
          ),
    ...
    KN = (e, t) => {
      ...
      return /^ | $/.test(t)
        ? ((e, t, n) => {
            ...
            return (
              (n = Mg(o, Ya.fromRangeStart(t))
                ? n.replace(/^ /, "&nbsp;")
                : n.replace(/^&nbsp;/, " ")),
              Ig(o, Ya.fromRangeEnd(t))
                ? n.replace(/(&nbsp;| )(<br( \/)>)?$/, "&nbsp;")
                : n.replace(/&nbsp;(<br( \/)?>)?$/, " ")
            );
          })(o, n.getRng(), t)
            ...
            ih(
              ...
              (t) =>
                ((t) =>
                  Kn(t, e).orThunk(() =>
                    "font" === Mt(t)
                      ? we(YN, e).bind((e) => Gt(t, e))
                      : M.none()
                  ))(t),
              (e) => vn(fn(t), e)
            ))(e, t, n.dom).or(
            ((e, t) => M.from(Hs.DOM.getStyle(t, e, !0)))(e, n.dom)
          )
        )
        .getOr(""),
    QN = XN("font-size"),
    ...
    tR = (e, t) => {
      if (/^[0-9.]+$/.test(t)) {
        ...
        if (n >= 1 && n <= 7) {
          const o = ((e) =>
              Bt.explode(e.options.get("font_size_style_values")))(e),
      ...
      WN(e),
        ...
        ((e) => {
          e.editorCommands.addCommands({
            ...
            insertImage: (t, n, o) => {
              GN(e, e.dom.createHTML("img", { src: o }));
            },
          ...
          ((e) => {
            ...
            e.editorCommands.addCommands({
              ...
              FontName: (t, n, o) => {
                ((e, t) => {
                  const n = tR(e, t);
                  e.formatter.toggle("fontname", { value: nR(n) }),
                    e.nodeChanged();
                })(e, o);
              },
              FontSize: (t, n, o) => {
                ((e, t) => {
                  e.formatter.toggle("fontsize", { value: tR(e, t) }),
                    e.nodeChanged();
                })(e, o);
              },
              LineHeight: (t, n, o) => {
            ...
            ((e) => {
              ...
              e.editorCommands.addCommands(
                ...
                e.editorCommands.addQueryValueHandler("FontName", () =>
                  ((e) => eR(e, (t) => JN(e.getBody(), t.dom)).getOr(""))(e)
                ),
                e.editorCommands.addQueryValueHandler("FontSize", () =>
                  ((e) => eR(e, (t) => QN(e.getBody(), t.dom)).getOr(""))(e)
                ),
                  ...
                  (t
                    ...
                    : ((e) => {
                        ...
                        if (e.dom.isChildOf(r, n))
                          return wf(r), Cf(e, o), void kf(e);
                        e.inline ||
                          (Nt.browser.isOpera() || wf(n), e.getWin().focus()),
  ...
  const sR = "data-mce-contenteditable",
      ...
      ((e, t, n) => {
        ...
        t
          ? (e.selection.controlSelection.hideResizeRect(),
            ...
            (e.readonly = !0),
            iR(n, !1),
            $(na(n, '*[contenteditable="true"]'), (e) => {
              qt(e, sR, "true"), iR(e, !1);
            }))
          : ((e.readonly = !1),
            iR(n, !0),
            $(na(n, '*[data-mce-contenteditable="true"]'), (e) => {
              Xt(e, sR), iR(e, !0);
            }),
            aR(e, "StyleWithCSS", !1),
            aR(e, "enableInlineTableEditing", !1),
            aR(e, "enableObjectResizing", !1),
            ((e) =>
              xf(e) ||
              ((e) => {
                const t = Mn(fn(e.getElement()));
    ...
    cR = (e) => {
      e.parser.addAttributeFilter("contenteditable", (t) => {
        dR(e) &&
          $(t, (e) => {
            e.attr(sR, e.attr("contenteditable")),
    ...
    pR = {
      ...
      dispatch(e, t, n) {
        ...
        if (o.removed && "remove" !== e && "detach" !== e)
          return Rs(e.toLowerCase(), null != t ? t : {}, o);
        const r = gR(o).dispatch(e, t);
        if (!1 !== n && o.parent) {
          let t = o.parent();
          for (; t && !r.isPropagationStopped(); )
            t.dispatch(e, r, !1), (t = t.parent());
        }
        return r;
      },
      on(e, t, n) {
  ...
  const vR = (e, t) => {
      ...
      const n = bl(e);
      return n
        ? (e.eventRoot || (e.eventRoot = hR.select(n)[0]), e.eventRoot)
        : e.getBody();
    },
    yR = (e, t, n) => {
      ((e) => !e.hidden && !dR(e))(e)
        ...
        : dR(e) &&
          ((e, t) => {
            if (((e) => "click" === e.type)(t) && !em.metaKeyPressed(t)) {
              const n = fn(t.target);
              ((e, t) =>
                Go(t, "a", (t) => vn(t, fn(e.getBody()))).bind((e) =>
                  Gt(e, "href")
                ))(e, n).each((n) => {
        ...
        "focus" !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                (n.dom.unbind(vR(n, e), e, n.delegates[e]),
    ...
    NR = (e, t, n, o) => {
      ...
      r.deactivate(),
        r.editorReadOnly !== s.editorReadOnly && lR(e, s.editorReadOnly),
        t.set(o),
        ((e, t) => {
      ...
      RR(AR(e.toLowerCase(), "+"), (e) => {
        e in TR
          ...
          : ((n.charCode = e.charCodeAt(0)),
            (n.keyCode = OR[e] || e.toUpperCase().charCodeAt(0)));
      });
      const r = [n.keyCode];
      for (t in TR) n[t] ? r.push(t) : (n[t] = !1);
      return (
        (n.id = r.join(",")),
        n.access && ((n.alt = !0), o ? (n.ctrl = !0) : (n.shift = !0)),
        n.meta && (o ? (n.meta = !0) : ((n.ctrl = !0), (n.meta = !1))),
        n
      );
    };
  class DR {
    ...
    createShortcut(e, t, n, o) {
      ...
      return (
        (r[r.length - 1] = Bt.extend(r[r.length - 1], {
          func: n,
          scope: o || this.editor,
        })),
        Bt.extend(r[0], {
  ...
  class FR {
    constructor(e, t, n) {
      ...
      (this.options = ((e, t) => {
        const n = {},
          ...
          r = (e, t, n) => {
            ...
            return SR(r)
              ? ((o[e] = r.value), !0)
              : (console.warn(
                  kR(`Invalid value passed for the ${e} option`, r)
                ),
                !1);
          },
          s = (e) => xe(n, e);
            ...
            const a = ((e) => m(e.processor))(s)
              ...
              i = ((e, t, n) => {
                if (!v(t)) {
                  ...
                  console.error(
                    kR(`Invalid default value passed for the "${e}" option`, o)
                  );
                }
              })(e, s.default, a);
        ...
        ((e) => {
          ...
          t("id", { processor: "string", default: e.id }),
            ...
            t("body_id", { processor: Di(e, "tinymce"), default: "tinymce" }),
            t("body_class", { processor: Di(e), default: "" }),
            ...
            t("font_css", {
              processor: (e) => {
                const t = m(e) || k(e, m);
                return t
                  ? { value: p(e) ? e : H(e.split(","), He), valid: t }
                  : {
                      valid: !1,
            ...
            t("invalid_styles", { processor: Bi }),
            t("valid_children", { processor: "string" }),
            t("valid_classes", { processor: Bi }),
            t("valid_elements", { processor: "string" }),
            t("valid_styles", { processor: Bi }),
      ...
      const l = rl(o);
      l &&
        (qs.ScriptLoader._setReferrerPolicy(l),
        Hs.DOM.styleSheetLoader._setReferrerPolicy(l)),
        (Qs.languageLoad = s("language_load")),
        (Qs.baseURL = n.baseURL),
        this.setDirty(!1),
        (this.documentBaseURI = new wv(Mi(o), { base_uri: this.baseUri })),
        (this.baseURI = this.baseUri),
        (this.inline = Rl(o)),
        (this.shortcuts = new DR(this)),
        (this.editorCommands = new rR(this)),
        oR(this);
      ...
      ((e) => {
        ...
        e.on("remove", () => {
          ...
          (e.ui.styleSheetLoader = ((e, t) =>
            Xo.forElement(e, { contentCssCors: Ml(t), referrerPolicy: rl(t) }))(
            o,
            e
          )),
          Rl(e)
        ...
        s &&
          ...
          Al(e) &&
            !No(e.getElement()) &&
            (DN.insertAfter(DN.create("input", { type: "hidden", name: t }), t),
            (e.hasHiddenInput = !0)),
          (e.formEventDelegate = (t) => {
            e.dispatch(t.type, t);
          }),
          DN.bind(s, "submit reset", e.formEventDelegate),
          e.on("reset", () => {
            e.resetContent();
          }),
          !Ol(e) ||
          ...
          (e.windowManager = Fy(e)),
          (e.notificationManager = Ly(e)),
    ...
    show() {
      ...
      e.hidden &&
        ...
        e.inline
          ...
          : (LR.show(e.getContainer()), LR.hide(e.id)),
        e.load(),
        e.dispatch("show"));
    }
    hide() {
      ...
      e.hidden ||
        ...
        e.inline
          ...
          : (LR.hide(e.getContainer()),
            LR.setStyle(e.id, "display", e.orgDisplay)),
        (e.hidden = !0),
        e.dispatch("hide"));
    }
    isHidden() {
    ...
    resetContent(e) {
      void 0 === e
        ? Cy(this, this.startContent, { format: "raw" })
        : Cy(this, e),
    ...
    getContainer() {
      ...
      return (
        e.container ||
          (e.container = LR.get(e.editorContainer || e.id + "_parent")),
        e.container
      );
    }
    ...
    getElement() {
      return (
        this.targetElm || (this.targetElm = LR.get(this.id)), this.targetElm
      );
    }
    getWin() {
      const e = this;
      ...
      return (
        e.contentWindow ||
          ((t = e.iframeElement), t && (e.contentWindow = t.contentWindow)),
        e.contentWindow
      );
    }
    getDoc() {
      ...
      ((e) => {
        if (!e.removed) {
          ...
          o && e.save({ is_removing: !0 }),
            ...
            e.hasHiddenInput && r && _y.remove(r.nextSibling),
            ((e) => {
              e.dispatch("remove");
            })(e),
  ...
  const $R = (e) => {
    ...
    qR = (e) => {
      if (e !== VR) {
        const t = Hs.DOM;
        e
          ? (t.bind(window, "resize", $R), t.bind(window, "scroll", $R))
          : (t.unbind(window, "resize", $R), t.unbind(window, "scroll", $R)),
          (VR = e);
      }
    },
    WR = (e) => {
      ...
      return (
        (HR = K(HR, (t) => e !== t)),
        GR.activeEditor === e &&
          (GR.activeEditor = HR.length > 0 ? HR[0] : null),
        GR.focusedEditor === e && (GR.focusedEditor = null),
        t.length !== HR.length
      );
    },
    ...
    GR = {
      ...
      setup() {
        ...
        let t,
          n,
          o = "";
        (n = wv.getDocumentBaseUrl(document.location)),
          /^[^:]+:\/\/\/?[^\/]+\//.test(n) &&
            ((n = n.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, "")),
            /[\/\\]$/.test(n) || (n += "/"));
        ...
        var s;
        (e.baseURL = new wv(n).toAbsolute(t)),
          (e.documentBaseURL = n),
          (e.baseURI = new wv(e.baseURL)),
          (e.suffix = o),
          (s = e).on("AddEditor", O(vf, s)),
          s.on("RemoveEditor", O(yf, s));
      },
      overrideDefaults(e) {
        const t = e.base_url;
        ...
        return (
          n === e ||
            ...
            jR ||
              ...
              window.addEventListener("beforeunload", jR))),
          e
        );
      },
      createEditor(e, t) {
      ...
      remove(e) {
        ...
        if (e) {
          if (!m(e))
            return (
              ...
              h(t.get(o.id))
                ? null
                : (WR(o) && t.dispatch("RemoveEditor", { editor: o }),
                  0 === HR.length &&
                    window.removeEventListener("beforeunload", jR),
                  o.remove(),
                  qR(HR.length > 0),
                  o)
            );
        ...
        } else for (n = HR.length - 1; n >= 0; n--) t.remove(HR[n]);
      },
      execCommand(e, t, n) {
        var o;
        const r = this,
      ...
      _setBaseUrl(e) {
        (this.baseURL = new wv(this.documentBaseURL).toAbsolute(
          e.replace(/\/+$/, "")
        )),
          (this.baseURI = new wv(this.baseURL));
      },
    };
  GR.setup();
  const YR = (() => {
        ...
        load: (n, o) => {
          ...
          if (void 0 !== e[n]) return e[n];
          {
            const a = new Promise((e, a) => {
              ...
              (t[n] = i.resolve),
                qs.ScriptLoader.loadScript(o).then(
                  () => i.start(s),
                  () => i.reject(r)
                );
            });
